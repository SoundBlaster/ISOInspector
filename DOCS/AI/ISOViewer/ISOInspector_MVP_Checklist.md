...
- [ ] C1. Stubs: `ftyp`, `mvhd`, `tkhd`, `mdhd`, `hdlr` (input/output types only) **(In Progress — `mdhd` parser wiring underway; others remain completed via existing registry entries.)**
