...
- [ ] J4. Add zero-trust logging policies ensuring file paths are hashed or redacted in diagnostics outputs. **(In Progress — tracked in `DOCS/INPROGRESS/G4_Zero_Trust_Logging.md`.)**
