...
- [x] B2. Define `BoxNode`: `header`, `children: [BoxNode]`, `payload: Payload?`, `warnings: [Warning]`. _(Completed — see `DOCS/INPROGRESS/Summary_of_Work.md` for the BoxNode aggregate rollout recap and follow-up notes.)_
