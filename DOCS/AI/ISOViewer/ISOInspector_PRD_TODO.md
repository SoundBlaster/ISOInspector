...
- [ ] 🔴 **P0+** C14. `edts/elst`: edit list entries. _(Scope documented in `DOCS/TASK_ARCHIVE/120_C14a_Finalize_Edit_List_Scope/C14a_Finalize_Edit_List_Scope.md`; parser implementation archived in `DOCS/TASK_ARCHIVE/121_C14b_Implement_elst_Parser/C14b_Implement_elst_Parser.md`, with validation and fixture work continuing under tasks C14c–C14d.)_ **(In Progress — C14c validation wiring archived in `DOCS/TASK_ARCHIVE/122_C14c_Edit_List_Duration_Validation/`; C14d fixture updates now tracked in `DOCS/INPROGRESS/C14d_Refresh_Edit_List_Fixtures.md`.)**
