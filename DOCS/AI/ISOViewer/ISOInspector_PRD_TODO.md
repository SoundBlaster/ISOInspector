...
- [ ] B2+. AsyncSequence event stream integration for `ParsePipeline`, wiring the live streaming interface for CLI and SwiftUI consumers. _(In Progress — see `DOCS/INPROGRESS/B2_Plus_AsyncSequence_Event_Stream.md`.)_
