...
- [x] C16.4 Future codec payload descriptors (e.g., Dolby Vision, enhanced audio) ensure registry coverage stays current. **(Completed — see `DOCS/INPROGRESS/Summary_of_Work.md` for implementation notes and `DOCS/TASK_ARCHIVE/103_C2_mvhd_Movie_Header_Parser/C6_Codec_Payload_Additions.md` for historical research.)**
