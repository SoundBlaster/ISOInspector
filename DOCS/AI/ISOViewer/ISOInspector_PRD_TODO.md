...
- [ ] T1.2. Extend `ParseTreeNode` with `issues` and `status` fields. _(In Progress — see `DOCS/INPROGRESS/T1_2_Extend_ParseTreeNode_Status_and_Issues.md` for the active PRD.)_
