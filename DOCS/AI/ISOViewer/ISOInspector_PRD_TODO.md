...
- [ ] Codec validation coverage expansion for `avcC`/`hvcC` warnings across ParsePipeline and CLI/JSON snapshots. _(In Progress — see `DOCS/INPROGRESS/Codec_Validation_Coverage_Expansion.md`; follow-up from `DOCS/TASK_ARCHIVE/143_E4_Verify_avcC_hvcC_Invariants/Summary_of_Work.md`.)_
