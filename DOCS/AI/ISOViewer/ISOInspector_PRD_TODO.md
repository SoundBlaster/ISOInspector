...
- [ ] 🛠️ T2.4. Validation rules emit `ParseIssue` diagnostics in lenient mode. _(In Progress — refactor VR-001…VR-015 to honor tolerance settings while strict mode continues throwing.)_
