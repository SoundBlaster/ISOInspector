...
- [x] 🔴 **P0+** C15. Metadata: `udta`, `meta` (handler), `keys`, `ilst` (basic types). **(Completed — see `DOCS/TASK_ARCHIVE/125_C15_Metadata_Box_Coverage/C15_Metadata_Box_Coverage.md` and `DOCS/TASK_ARCHIVE/125_C15_Metadata_Box_Coverage/Summary_of_Work.md`.)**
  ...
  > **Follow-up:** Surface remaining MP4RA metadata value types (e.g., GIF/TIFF/image variants, signed fixed-point) when fixtures land — tracked via `@todo` in `BoxParserRegistry+Metadata.swift`, `todo.md`, and the archived `DOCS/TASK_ARCHIVE/200_T3_7_Integrity_Navigation_Filters/next_tasks.md`. _(Completed — see `DOCS/TASK_ARCHIVE/129_C15_Metadata_Value_Type_Expansion/C15_Metadata_Value_Type_Expansion.md`.)_
...
- [x] Fragment fixture coverage — *(Completed — see `DOCS/TASK_ARCHIVE/138_Fragment_Fixture_Coverage/Fragment_Fixture_Coverage.md` and `DOCS/TASK_ARCHIVE/138_Fragment_Fixture_Coverage/Summary_of_Work.md` for fixture details. Validator/CLI polish documentation now lives in `DOCS/TASK_ARCHIVE/139_Validator_and_CLI_Polish/Summary_of_Work.md`, while real-world asset licensing follow-ups remain queued in the archived `DOCS/TASK_ARCHIVE/200_T3_7_Integrity_Navigation_Filters/next_tasks.md` and the active `DOCS/INPROGRESS/blocked.md`.)*
...
- [x] T2.3. Aggregate parse issue metrics for UI and CLI ribbons. _(Completed — archived in `DOCS/TASK_ARCHIVE/184_T2_3_Aggregate_Parse_Issue_Metrics_for_UI_and_CLI_Ribbons/`; ribbon design follow-ups remain documented in the archived `DOCS/TASK_ARCHIVE/200_T3_7_Integrity_Navigation_Filters/next_tasks.md`.)_
...
- **T3:** UI corruption views (badges, placeholders, "Integrity" tab, export actions) — **100% complete** _(T3.7 navigation filters now ship issue-focused toggles, outline jumps, and shortcuts across macOS/iPadOS builds.)_
...
- [x] H5. macOS SwiftUI automation covering streaming default selection and synchronized detail updates. Implemented via
  ...
  note.
  - Hardware validation run remains **Blocked** pending macOS runner — tracked in `DOCS/TASK_ARCHIVE/50_Summary_of_Work_2025-02-16/51_ParseTreeStreamingSelectionAutomation_macOS_Run.md`, the archived `DOCS/TASK_ARCHIVE/200_T3_7_Integrity_Navigation_Filters/next_tasks.md`, and `DOCS/INPROGRESS/blocked.md`.
...
- [x] J1. Ship FilesystemAccessKit core API with async open/save/bookmark helpers shared by all targets. *(Completed — archived in `DOCS/TASK_ARCHIVE/69_G1_FilesystemAccessKit_Core_API/`; ongoing bookmark persistence and sandbox profile planning remain documented in the archived `DOCS/TASK_ARCHIVE/200_T3_7_Integrity_Navigation_Filters/next_tasks.md` and the Phase G workplan, with active blockers logged in `DOCS/INPROGRESS/blocked.md`.)*
