...
- [ ] I3. App theming (icon, light/dark). _(Accent palette delivery archived in [`DOCS/TASK_ARCHIVE/80_Summary_of_Work_2025-10-17_App_Theming/`](../../TASK_ARCHIVE/80_Summary_of_Work_2025-10-17_App_Theming/) while production icon raster assets remain outstanding — tracked via `todo.md` and [`DOCS/INPROGRESS/next_tasks.md`](../../INPROGRESS/next_tasks.md).)_
