...
- [ ] 🔴 **P0+** C14. `edts/elst`: edit list entries. _(Scope documented in `DOCS/TASK_ARCHIVE/120_C14a_Finalize_Edit_List_Scope/C14a_Finalize_Edit_List_Scope.md`; implementation/validation/fixture work tracked under tasks C14b–C14d.)_ **(In Progress — see `DOCS/INPROGRESS/C14b_Implement_elst_Parser.md` for parser implementation.)**
