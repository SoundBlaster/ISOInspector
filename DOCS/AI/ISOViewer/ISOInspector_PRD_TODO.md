...
- [ ] G7. State management: `DocumentVM` holds root; `NodeVM` for selection; `HexVM` for slice & highlight. _(In Progress — see `DOCS/INPROGRESS/G7_State_Management_ViewModels.md`.)_
