...
- [x] E2. Detect zero/negative progress loops; cap nesting depth. **(Completed — guard rails landed in `DOCS/INPROGRESS/Summary_of_Work.md` with validation notes retained in `DOCS/INPROGRESS/E2_Detect_Progress_Loops.md`.)**
