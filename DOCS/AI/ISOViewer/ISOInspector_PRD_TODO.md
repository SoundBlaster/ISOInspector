...
- [x] T3.5 — Contextual Status Labels. _(Completed — outline rows and detail inspector now display synchronized status chips for tolerant parsing metadata; see `DOCS/INPROGRESS/T3_5_Contextual_Status_Labels.md` for scope.)_
