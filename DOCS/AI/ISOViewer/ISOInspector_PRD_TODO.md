...
- [x] J2. Persist security-scoped bookmarks and integrate with recents/session restoration flows. *(Completed — see `DOCS/INPROGRESS/Summary_of_Work.md` for audit logging and ledger reconciliation notes.)*
