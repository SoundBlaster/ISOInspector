...
- [ ] E4. Verify `avcC/hvcC` invariants; flag inconsistencies. _(In Progress — see `DOCS/INPROGRESS/E4_Verify_avcC_hvcC_Invariants.md` for validation scope and acceptance notes.)_
