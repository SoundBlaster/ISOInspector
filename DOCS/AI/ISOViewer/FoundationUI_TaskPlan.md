...
- [ ] **P0** Create NavigationSplitScaffold pattern → **NEW 2025-11-12**
  ...
  - Capture ISOInspector column responsibilities: Sidebar → recent files/global controls, Content → BoxTree navigator, Detail → Box content/preview surface, Inspector → optional property overlay (metadata + Bookmarks/Notes tied to the selected box)
...
- [ ] **P1** Update existing patterns to adopt shared navigation model → **NEW 2025-11-12**
  ...
  - Ensure column visibility controls expose accessibility shortcuts and VoiceOver labels, and demonstrate the inspector as an optional property overlay that consumes Box-derived metadata plus user Bookmarks/Notes without duplicating BoxTree or Detail content
