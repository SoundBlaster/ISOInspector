...
- [x] D6. Stubs: `senc/saio/saiz` placeholders _(Completed — see `DOCS/TASK_ARCHIVE/150_Summary_of_Work_2025-10-22_Sample_Encryption_Metadata/Summary_of_Work.md`.)_
...
- [x] E4. avcC/hvcC invariants list _(Completed — see `DOCS/TASK_ARCHIVE/143_E4_Verify_avcC_hvcC_Invariants/Summary_of_Work.md`.)_
