...
| T3.3 | Extend details pane with "Corruption" section: error code, byte offsets, affected range, suggested actions. | High | 2d | T2.1 | Selecting corrupt node shows detailed diagnostics; fields copyable. *(In Progress — see `DOCS/INPROGRESS/T3_3_Integrity_Detail_Pane.md`.)* |
