...
| T5.3 | Add UI rendering smoke tests for corrupt nodes (badges, placeholders, detail sections). | Medium | 1.5d | T3.1-T3.7, T5.1 | UI tests confirm visual corruption indicators present. *(In Progress — see `DOCS/INPROGRESS/210_T5_3_UI_Corruption_Smoke_Tests.md`.)* |
