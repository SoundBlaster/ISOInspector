...
| T3.2 | Add corruption badges (warning triangle icon) to tree view nodes; tooltip shows issue summary. **(✅ Completed — see `DOCS/INPROGRESS/Summary_of_Work.md`)** | High | 1.5d | T1.2, T2.1 | ✅ Badges render for corrupt nodes with severity colors, accessible labels, and tooltip summaries. |
