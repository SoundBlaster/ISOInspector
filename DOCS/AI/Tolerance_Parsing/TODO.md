...
| T3.2 | Add corruption badges (warning triangle icon) to tree view nodes; tooltip shows issue summary. | High | 1.5d | T1.2, T2.1 | 🚧 In Progress — Nodes with issues display badge; VoiceOver announces corruption state. |
