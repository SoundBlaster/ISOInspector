...
> **In Progress:** Task H3 — JSON export snapshot tests are being scoped in `DOCS/INPROGRESS/H3_JSON_Export_Snapshot_Tests.md` to lock baselines for representative fixtures.
