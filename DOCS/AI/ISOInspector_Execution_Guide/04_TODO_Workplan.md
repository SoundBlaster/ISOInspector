...
| D4 | Create batch mode processing with aggregated summary + CSV export. | Medium | 1.5 | D2 | Swift, CSV writer | CLI handles multiple files; CSV contains expected rows and metrics. _(In Progress — see `DOCS/INPROGRESS/51_D4_CLI_Batch_Mode.md`.)_ |
