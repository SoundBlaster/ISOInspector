...
>
> **Completed:** Advisory validation **E3 — Warn on Unusual Top-Level Ordering** now emits guidance when `ftyp`/`moov` sequences deviate from expectations while respecting streaming layouts; implementation recap in `DOCS/INPROGRESS/Summary_of_Work.md`.
