...
> **Completed:** Task **E4 — Verify avcC/hvcC Invariants** delivered codec validation checks across ISOInspectorKit, CLI messaging, and JSON exports. See `DOCS/INPROGRESS/Summary_of_Work.md` for the validator roll-out, regression coverage, and follow-up notes.
