...
| F5 | Finalize release checklist and go-live runbook. | Medium | 1 | E4, F2 | Markdown | Checklist covers QA sign-off, documentation updates, release packaging. **(In Progress — see `DOCS/INPROGRESS/F5_Finalize_Release_Checklist_and_Go_Live_Runbook.md`.)** |
