...
| F3 | Author developer onboarding guide and API reference. *(In Progress — see `DOCS/INPROGRESS/F3_Developer_Onboarding_Guide.md`.)* | Medium | 2 | A3, B6, C3 | DocC, Markdown | Guides published; includes setup, architecture, and extension instructions. |
