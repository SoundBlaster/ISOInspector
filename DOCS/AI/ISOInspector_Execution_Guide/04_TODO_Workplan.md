...
| F4 | Produce user manual covering CLI and App workflows. | Medium | 1.5 | D3, E2 | Markdown | Manual includes screenshots, command examples, troubleshooting. (In Progress 🚧 — see `DOCS/INPROGRESS/F4_User_Manual.md`.) |
