...
>
> **In Progress:** _None — validator and CLI polish wrapped and archived in `DOCS/TASK_ARCHIVE/139_Validator_and_CLI_Polish/`, while codec fixture licensing follow-ups remain blocked pending external approvals and stay queued in `DOCS/INPROGRESS/next_tasks.md`._
>
