...
| E4 | Prepare app distribution configuration (bundle ID, entitlements, notarization). | Medium | 1.5 | E2 | Xcode, Notarytool | App builds and notarizes successfully; entitlements validated. *(In Progress — task doc `DOCS/INPROGRESS/54_E4_Prepare_App_Distribution_Configuration.md` opened to drive implementation.)* |
