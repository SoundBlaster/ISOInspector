...
| F4 | Produce user manual covering CLI and App workflows. | Medium | 1.5 | D3, E2 | Markdown | Manual published under `Documentation/ISOInspector.docc/Manuals/` with CLI/App walkthroughs and troubleshooting notes. |
