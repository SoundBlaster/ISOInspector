...
- [x] **A2 — Implement `MappedReader` using `Data(..., .mappedIfSafe)` with bounds-checked slices.** Completed — see `DOCS/TASK_ARCHIVE/61_A2_Implement_MappedReader/Summary_of_Work.md` for the delivery record.
