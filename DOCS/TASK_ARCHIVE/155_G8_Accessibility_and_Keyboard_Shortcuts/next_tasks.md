...
- ✅ **G8 — Accessibility & Keyboard Shortcuts** _(Completed)_: Hardware focus shortcuts now flow through a shared catalog and Focus command menu so macOS and iPadOS expose the same key bindings and restore focus targets without pointer input. Summary recorded in `DOCS/TASK_ARCHIVE/155_G8_Accessibility_and_Keyboard_Shortcuts/Summary_of_Work.md`.
