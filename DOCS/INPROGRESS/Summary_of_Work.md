...
- Documented remaining action to rerun against the 1 GiB reference fixture on macOS hardware once available. 【F:DOCS/INPROGRESS/205_T5_4_Performance_Benchmark.md†L39-L55】
