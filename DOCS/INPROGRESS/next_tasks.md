...
- [x] Implement C11 `stss` sync sample table parser to surface random-access sample numbers. _(Completed — see `DOCS/TASK_ARCHIVE/115_C11_stss_Sync_Sample_Table/Summary_of_Work.md`.)_
