...
- [ ] Implement Task G6 export actions so the app can produce JSON for the full tree or a selected subtree. **(In Progress — see `DOCS/INPROGRESS/G6_Export_JSON_Actions.md`.)**
