...
- [x] #T1.1 Define `ParseIssue` model with severity, code, message, and byte range support for tolerant parsing. _(Completed — see `DOCS/INPROGRESS/Summary_of_Work.md` for implementation recap.)_
