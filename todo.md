...
- [ ] PDD:1h Connect CoreData session bookmark diffs to persisted bookmark entities once reconciliation rules are defined. **(In Progress — see `DOCS/INPROGRESS/C7_Connect_Bookmark_Diffs_to_Resolved_Bookmarks.md`.)**
