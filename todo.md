...
- [x] PDD:1h Thread mvhd/tkhd/mdhd timescale context into BoxParserRegistry.editListEnvironmentProvider so normalized edit list seconds do not rely on test hooks. Track follow-up in `DOCS/INPROGRESS/C14b_Implement_elst_Parser.md`.
