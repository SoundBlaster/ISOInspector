...
- [ ] PDD:45m Generate production app icon raster assets from the brand vector source and populate `AppIcon.appiconset` filenames so notarized builds include the final artwork.
