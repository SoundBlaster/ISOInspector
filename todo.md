...
- [x] PDD:45m Extract codec-specific metadata for additional sample entry types once dedicated entry payload models land. **(Completed — see `DOCS/INPROGRESS/C6_Extend_stsd_Codec_Metadata.md` and `DOCS/INPROGRESS/Summary_of_Work.md`.)**
