...
- [ ] PDD:45m Generate production app icon raster assets from the brand vector source and populate `AppIcon.appiconset` filenames so notarized builds include the final artwork. _(In Progress — see `DOCS/INPROGRESS/I3_App_Icon_Rasterization.md`; accent palette groundwork archived in `DOCS/TASK_ARCHIVE/80_Summary_of_Work_2025-10-17_App_Theming/Summary_of_Work.md`.)_
