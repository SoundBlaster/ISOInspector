...
/// 5. Set `isRecording = false`
@MainActor final class BadgeSnapshotTests: XCTestCase {
    // MARK: - Light Mode Tests

    func testBadgeInfoLightMode() {
        let badge = Badge(text: "INFO", level: .info)
        let view = badge.frame(width: 200, height: 100)
    ...
    func testBadgeInfoDarkMode() {
        let badge = Badge(text: "INFO", level: .info)
        let view = badge.frame(width: 200, height: 100).preferredColorScheme(.dark)
    ...
    func testBadgeWithIconInfo() {
        ...
        let view = badge.frame(width: 250, height: 100)
    ...
    func testBadgeDynamicTypeExtraSmall() {
        let badge = Badge(text: "WARNING", level: .warning)
        let view = badge.frame(width: 200, height: 100).environment(\.sizeCategory, .extraSmall)
    ...
    func testBadgeDynamicTypeMedium() {
        let badge = Badge(text: "WARNING", level: .warning)
        let view = badge.frame(width: 200, height: 100).environment(\.sizeCategory, .medium)
    ...
    func testBadgeDynamicTypeExtraExtraLarge() {
        let badge = Badge(text: "WARNING", level: .warning)
        let view = badge.frame(width: 300, height: 150).environment(
    ...
    func testBadgeShortText() {
        ...
        let view = badge.frame(width: 150, height: 100)
    ...
    func testBadgeLongText() {
        ...
        let view = badge.frame(width: 300, height: 100)
    ...
    func testBadgeRTLLocale() {
        ...
        let view = badge.frame(width: 200, height: 100).environment(\.layoutDirection, .rightToLeft)
    ...
    func testBadgeWithIconRTL() {
        ...
        let view = badge.frame(width: 250, height: 100).environment(\.layoutDirection, .rightToLeft)
