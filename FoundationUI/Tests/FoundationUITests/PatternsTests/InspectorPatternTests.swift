...
@MainActor final class InspectorPatternTests: XCTestCase {
    // MARK: - Initialization

    func testInspectorPatternStoresTitle() {
        // Given
        let pattern = InspectorPattern(title: "Metadata") { Text("Content") }

        // Then
        XCTAssertEqual(
            pattern.title, "Metadata", "InspectorPattern should store the provided title")
    }

    func testInspectorPatternUsesThinMaterialByDefault() {
        // Given
        let pattern = InspectorPattern(title: "Details") { Text("Content") }

        // Then
        XCTAssertEqual(
            String(describing: pattern.material), String(describing: Material.thinMaterial),
            "InspectorPattern should default to thin material background")
    }

    func testInspectorPatternMaterialModifierProducesNewInstance() {
        // Given
        let basePattern = InspectorPattern(title: "Details") { Text("Content") }
        ...
        // Then
        XCTAssertEqual(
            String(describing: updatedPattern.material), String(describing: Material.regular),
    ...
    func testInspectorPatternCapturesViewBuilderContent() {
        ...
        _ = pattern.content
        XCTAssertNotNil(
            pattern.content, "InspectorPattern should capture the provided content view")
    }
    ...
    func testInspectorPatternConformsToView() {
        // Given
        let pattern = InspectorPattern(title: "Conformance") { Text("Content") }
    ...
    func testInspectorPatternWithRegularMaterial() {
        // Given
        let pattern = InspectorPattern(title: "Regular", material: .regular) { Text("Content") }

        // Then
        XCTAssertEqual(
            String(describing: pattern.material), String(describing: Material.regular),
            "InspectorPattern should support regular material")
    }

    func testInspectorPatternWithThickMaterial() {
        // Given
        let pattern = InspectorPattern(title: "Thick", material: .thick) { Text("Content") }

        // Then
        XCTAssertEqual(
            String(describing: pattern.material), String(describing: Material.thick),
            "InspectorPattern should support thick material")
    }

    func testInspectorPatternWithUltraThinMaterial() {
        // Given
        let pattern = InspectorPattern(title: "UltraThin", material: .ultraThin) { Text("Content") }

        // Then
        XCTAssertEqual(
            String(describing: pattern.material), String(describing: Material.ultraThin),
    ...
    func testInspectorPatternWithUltraThickMaterial() {
        ...
        // Then
        XCTAssertEqual(
            String(describing: pattern.material), String(describing: Material.ultraThick),
    ...
    func testMaterialModifierCanBeChained() {
        // Given
        let pattern = InspectorPattern(title: "Chain") { Text("Content") }
        ...
        // Then
        XCTAssertEqual(
            String(describing: updated2.material), String(describing: Material.thick),
    ...
    func testInspectorPatternWithComplexContent() {
        ...
        // Then
        XCTAssertNotNil(
            pattern.content, "InspectorPattern should handle complex content composition")
    }

    func testInspectorPatternWithEmptyContent() {
        // Given
        let pattern = InspectorPattern(title: "Empty") { EmptyView() }
    ...
    func testInspectorPatternWithEmptyTitle() {
        // Given
        let pattern = InspectorPattern(title: "") { Text("Content") }
    ...
    func testInspectorPatternWithLongTitle() {
        ...
        let pattern = InspectorPattern(title: longTitle) { Text("Content") }
    ...
    func testInspectorPatternWithSpecialCharactersInTitle() {
        ...
        let pattern = InspectorPattern(title: specialTitle) { Text("Content") }

        // Then
        XCTAssertEqual(
            pattern.title, specialTitle,
            "InspectorPattern should handle special characters in title")
    }
    ...
    func testInspectorPatternUsesDesignSystemTokens() {
        // Given
        let pattern = InspectorPattern(title: "Tokens") { Text("Content") }
    ...
    // MARK: - Platform-Specific Behavior
        ...
        func testInspectorPatternPlatformPaddingOnMacOS() {
            // Given
            let pattern = InspectorPattern(title: "macOS") { Text("Content") }
        ...
        func testInspectorPatternPlatformPaddingOnIOS() {
            // Given
            let pattern = InspectorPattern(title: "iOS") { Text("Content") }
    ...
    func testInspectorPatternHasAccessibilityLabel() {
        ...
        let pattern = InspectorPattern(title: title) { Text("Content") }
    ...
    func testInspectorPatternWithBoxDetails() {
        ...
        // Then
        XCTAssertEqual(
            pattern.title, "Box Details", "InspectorPattern should work with box details")
    }
    ...
    func testInspectorPatternCanBeNestedInOtherViews() {
        ...
        struct ContainerView: View {
            var body: some View { VStack { InspectorPattern(title: "Nested") { Text("Content") } } }
        }
