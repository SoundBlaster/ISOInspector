// swift-tools-version: 6.0
    ...
    @MainActor final class NavigationSplitScaffoldTests: XCTestCase {
        ...
        func testNavigationModelCanBeSetInEnvironment() {
            ...
            let view = TestView().environment(\.navigationModel, model)
        ...
        func testScaffoldSupportsAccessibilityLabels() {
            ...
            struct AccessibleSidebarView: View {
                var body: some View { Text("Sidebar").accessibilityLabel("File Browser") }
            }
            ...
            let scaffold = NavigationSplitScaffold {
                ...
                Text("Detail").accessibilityLabel("Atom Inspector")
            }
        ...
        func testScaffoldHandlesComplexViewHierarchy() {
            ...
            struct ComplexSidebar: View {
                var body: some View {
                    NavigationStack { List { Section("Section 1") { Text("Item 1") } } }
                }
            }
            ...
            let scaffold = NavigationSplitScaffold {
                ...
                TabView {
                    Text("Tab 1").tabItem { Label("Tab 1", systemImage: "1.circle") }
                    Text("Tab 2").tabItem { Label("Tab 2", systemImage: "2.circle") }
                }
            } detail: {
                ScrollView {
                    VStack {
