...
final class ToolbarPatternTests: XCTestCase {
  ...
  func testToolbarItemsWithOnlyPrimary() {
    ...
    let items = ToolbarPattern.Items(
      primary: [
        .init(id: "p1", iconSystemName: "star", title: "Star")
      ],
      secondary: [],
      overflow: []
    )
  ...
  func testToolbarPatternInitialization() {
    // Given
    let items = ToolbarPattern.Items(
      primary: [.init(id: "test", iconSystemName: "star", title: "Test")],
      secondary: [],
      overflow: []
    )
  ...
  func testToolbarPatternBodyRendering() {
    ...
    let items = ToolbarPattern.Items(
      ...
      secondary: [
        .init(id: "s1", iconSystemName: "2.circle", title: "Secondary 1")
      ],
      overflow: [
        .init(id: "o1", iconSystemName: "3.circle", title: "Overflow 1")
      ]
    )
    let pattern = ToolbarPattern(items: items)
