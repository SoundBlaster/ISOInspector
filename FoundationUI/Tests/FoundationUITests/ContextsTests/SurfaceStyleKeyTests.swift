...
@testable import FoundationUI
    ...
    @MainActor final class SurfaceStyleKeyTests: XCTestCase {
        ...
        func testSurfaceStyleKey_DefaultValue_IsRegular() {
            ...
            // Assert
            XCTAssertEqual(
                defaultValue, .regular, "SurfaceStyleKey default value should be .regular material")
        }
        ...
        func testEnvironmentValues_DefaultSurfaceStyle_IsRegular() {
            ...
            // Assert
            XCTAssertEqual(
                surfaceStyle, .regular, "EnvironmentValues should default to .regular surface style"
            )
        }
        ...
        func testSurfaceMaterial_AccessibilityLabel_ReturnsCorrectValues() {
            // Assert
            XCTAssertEqual(SurfaceMaterial.thin.accessibilityLabel, "Thin material background")
            XCTAssertEqual(
                SurfaceMaterial.regular.accessibilityLabel, "Regular material background")
            XCTAssertEqual(SurfaceMaterial.thick.accessibilityLabel, "Thick material background")
            XCTAssertEqual(
                SurfaceMaterial.ultra.accessibilityLabel, "Ultra thick material background")
        }
