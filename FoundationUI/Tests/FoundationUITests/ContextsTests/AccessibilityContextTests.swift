    ...
    /// avoid magic numbers.
    @MainActor final class AccessibilityContextTests: XCTestCase {
        ...
        func testReduceMotion_DisablesAnimations() {
            let context = AccessibilityContext(
                prefersReducedMotion: true, prefersIncreasedContrast: false, prefersBoldText: false,
        ...
        func testReduceMotion_AllowsAnimations() {
            let context = AccessibilityContext(
                prefersReducedMotion: false, prefersIncreasedContrast: false,
                prefersBoldText: false, dynamicTypeSize: .large)
        ...
        func testIncreasedContrast_UsesLargeSpacing() {
            let context = AccessibilityContext(
                prefersReducedMotion: false, prefersIncreasedContrast: true, prefersBoldText: false,
                dynamicTypeSize: .large)
        ...
        func testHighContrastAccessibilitySpacing_UsesXLSpacing() {
            ...
            XCTAssertEqual(
                context.spacing(for: DS.Spacing.m), DS.Spacing.xl,
        ...
        func testBoldText_UsesBoldWeight() {
            let context = AccessibilityContext(
                prefersReducedMotion: false, prefersIncreasedContrast: false, prefersBoldText: true,
                dynamicTypeSize: .large)
        ...
        func testEnvironmentValues_AccessibilityContextRoundTrip() throws {
                ...
                let context = AccessibilityContext(
                    prefersReducedMotion: true, prefersIncreasedContrast: true,
                    prefersBoldText: true, dynamicTypeSize: .accessibility3)
        ...
        func testEnvironmentValues_DerivesDefaultsFromEnvironment() throws {
                ...
                environment.accessibilityContextOverrides = AccessibilityContextOverrides(
                    prefersReducedMotion: true, prefersIncreasedContrast: true,
                    prefersBoldText: true, dynamicTypeSize: .accessibility2)
        ...
        func testContextEquality_ComparesAllProperties() {
            ...
            let context3 = AccessibilityContext(
                prefersReducedMotion: false, prefersIncreasedContrast: true, prefersBoldText: true,
                dynamicTypeSize: .accessibility2)
