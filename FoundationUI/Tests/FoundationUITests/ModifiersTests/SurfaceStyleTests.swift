...
@MainActor final class SurfaceStyleTests: XCTestCase {
    ...
    func testSurfaceMaterialThinDescription() {
        ...
        XCTAssertEqual(
            description, "Thin material", "Thin material should have appropriate description")
    }
    ...
    func testSurfaceMaterialRegularDescription() {
        ...
        // Then: It should describe the material
        XCTAssertEqual(
            description, "Regular material", "Regular material should have appropriate description")
    }
    ...
    func testSurfaceMaterialThickDescription() {
        ...
        // Then: It should describe the material
        XCTAssertEqual(
            description, "Thick material", "Thick material should have appropriate description")
    }
    ...
    func testSurfaceMaterialUltraDescription() {
        ...
        // Then: It should describe the material
        XCTAssertEqual(
            description, "Ultra thick material",
    ...
    func testSurfaceMaterialThinAccessibilityLabel() {
        ...
        XCTAssertEqual(
            label, "Thin material background",
    ...
    func testSurfaceMaterialRegularAccessibilityLabel() {
        ...
        // Then: It should describe the material for VoiceOver
        XCTAssertEqual(
            label, "Regular material background",
    ...
    func testSurfaceMaterialThickAccessibilityLabel() {
        ...
        // Then: It should describe the material for VoiceOver
        XCTAssertEqual(
            label, "Thick material background",
    ...
    func testSurfaceMaterialUltraAccessibilityLabel() {
        ...
        // Then: It should describe the material for VoiceOver
        XCTAssertEqual(
            label, "Ultra thick material background",
    ...
    func testSurfaceMaterialThinFallbackColor() {
        ...
        XCTAssertNotNil(
            fallbackColor, "Thin material should have a fallback color for unsupported platforms")
    }
    ...
    func testSurfaceMaterialRegularFallbackColor() {
        ...
        // Then: It should have a valid fallback color
        XCTAssertNotNil(
            fallbackColor, "Regular material should have a fallback color for unsupported platforms"
        )
    }
    ...
    func testSurfaceMaterialThickFallbackColor() {
        ...
        // Then: It should have a valid fallback color
        XCTAssertNotNil(
            fallbackColor, "Thick material should have a fallback color for unsupported platforms")
    }
    ...
    func testSurfaceMaterialUltraFallbackColor() {
        ...
        // Then: It should have a valid fallback color
        XCTAssertNotNil(
            fallbackColor, "Ultra material should have a fallback color for unsupported platforms")
    }
    ...
    func testSurfaceMaterialAllCasesExist() {
        ...
        XCTAssertEqual(allCases.count, 4, "SurfaceMaterial should have exactly 4 cases")
