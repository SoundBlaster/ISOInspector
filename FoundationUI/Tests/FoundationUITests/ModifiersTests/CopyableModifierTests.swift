...
@testable import FoundationUI
    ...
    @MainActor final class CopyableModifierTests: XCTestCase {
        // MARK: - API Tests

        func testCopyableModifierAppliesCorrectly() {
            // Test that modifier can be applied to Text view
            let view = Text("Test Value").copyable(text: "Test Value")
        ...
        func testCopyableModifierWithFeedbackParameter() {
            ...
            let view = Text("Test").copyable(text: "Test", showFeedback: true)
        ...
        func testCopyableModifierWithoutFeedback() {
            ...
            let view = Text("Test").copyable(text: "Test", showFeedback: false)
        ...
        func testCopyableModifierInitialState() {
            ...
            let modifier = CopyableModifier(textToCopy: "Test", showFeedback: true)
            XCTAssertNotNil(modifier)// Note: State is private, verified through behavior
        }
        ...
        // MARK: - Platform-Specific Clipboard Tests
            ...
            func testMacOSClipboardSupport() {
                ...
                let view = Text("macOS Value").copyable(text: "macOS Value")
            ...
            func testMacOSKeyboardShortcut() {
                ...
                let view = Text("Shortcut Test").copyable(text: "Shortcut Test")
            ...
            func testIOSClipboardSupport() {
                ...
                let view = Text("iOS Value").copyable(text: "iOS Value")
        ...
        func testCopyableModifierShowsFeedback() {
            ...
            XCTAssertNotNil(view)// Future: Trigger copy and verify feedback appears
        }
        ...
        func testCopyableModifierHidesFeedback() {
            ...
            XCTAssertNotNil(view)// Behavior verification would require view introspection
        }
        ...
        func testCopyableModifierAccessibilityLabel() {
            ...
            let view = Text("Accessible").copyable(text: "Accessible")

            XCTAssertNotNil(view)// Future: Verify accessibility label includes copy hint
        }

        func testCopyableModifierVoiceOverAnnouncement() {
            // Should announce successful copy to VoiceOver
            let view = Text("VoiceOver Test").copyable(text: "VoiceOver Test")

            XCTAssertNotNil(view)// Manual verification: Implementation should use announcements
        }
        ...
        func testCopyableModifierUsesDesignSystemTokens() {
            ...
            let view = Text("DS Tokens").copyable(text: "DS Tokens")
        ...
        func testCopyableModifierWithVeryLongString() {
            ...
            let view = Text("Long Text").copyable(text: longText)
        ...
        func testCopyableModifierWithSpecialCharacters() {
            ...
            let view = Text("Special").copyable(text: specialText)
        ...
        func testCopyableModifierWithMultilineText() {
            ...
            let multilineText = """
                ...
                Line 3
                """
            let view = Text("Multiline").copyable(text: multilineText)
        ...
        func testMultipleCopyableModifiersOnSameView() {
            ...
            let view = Text("Test").copyable(text: "First").copyable(text: "Second")
        ...
        func testCopyableModifierWithOtherModifiers() {
            ...
            let view = Text("Test").font(DS.Typography.code).foregroundColor(DS.Colors.accent)
                .padding(DS.Spacing.m).copyable(text: "Test")
        ...
        func testCopyableModifierPerformance() {
            ...
            measure {
                for _ in 0..<100 {
                    _ = Text("Performance Test \(UUID())").copyable(text: "Performance Test")
                }
        ...
        func testCopyableModifierMemoryEfficiency() {
            ...
            for i in 0..<iterations {
                let view = Text("Memory Test \(i)").copyable(text: "Memory Test \(i)")
                XCTAssertNotNil(view)
        ...
        func testCopyableModifierWithBadgeComponent() {
            ...
            let view = Badge(text: "Test", level: .info).copyable(text: "Badge text")
        ...
        func testCopyableModifierInKeyValueRowContext() {
            ...
            let view = HStack {
                Text("Key:")
                Text("Value").copyable(text: "Value")
            }
