...
@MainActor final class CardStyleTests: XCTestCase {
    ...
    func testElevationLevelNoneHasNoShadow() {
        ...
        XCTAssertFalse(hasShadow, "Elevation.none should not apply shadow effects")
    }
    ...
    func testElevationLevelLowHasShadow() {
        ...
        XCTAssertTrue(hasShadow, "Elevation.low should apply subtle shadow effects")
    }
    ...
    func testElevationLevelMediumHasShadow() {
        ...
        // Then: It should have a shadow
        XCTAssertTrue(hasShadow, "Elevation.medium should apply moderate shadow effects")
    }
    ...
    func testElevationLevelHighHasShadow() {
        ...
        // Then: It should have a shadow
        XCTAssertTrue(hasShadow, "Elevation.high should apply prominent shadow effects")
    }
    ...
    func testElevationLevelLowShadowRadius() {
        ...
        XCTAssertEqual(
            shadowRadius, 2.0, accuracy: 0.01, "Low elevation should have shadow radius of 2.0")
    }
    ...
    func testElevationLevelMediumShadowRadius() {
        ...
        XCTAssertEqual(
            shadowRadius, 4.0, accuracy: 0.01, "Medium elevation should have shadow radius of 4.0")
    }
    ...
    func testElevationLevelHighShadowRadius() {
        ...
        XCTAssertEqual(
            shadowRadius, 8.0, accuracy: 0.01, "High elevation should have shadow radius of 8.0")
    }
    ...
    func testElevationLevelLowShadowOpacity() {
        ...
        XCTAssertEqual(
            shadowOpacity, 0.1, accuracy: 0.01, "Low elevation should have shadow opacity of 0.1")
    }
    ...
    func testElevationLevelMediumShadowOpacity() {
        ...
        XCTAssertEqual(
            shadowOpacity, 0.15, accuracy: 0.01,
    ...
    func testElevationLevelHighShadowOpacity() {
        ...
        XCTAssertEqual(
            shadowOpacity, 0.2, accuracy: 0.01, "High elevation should have shadow opacity of 0.2")
    }
    ...
    func testElevationLevelLowShadowYOffset() {
        ...
        XCTAssertEqual(yOffset, 1.0, accuracy: 0.01, "Low elevation should have Y offset of 1.0")
    }
    ...
    func testElevationLevelMediumShadowYOffset() {
        ...
        XCTAssertEqual(yOffset, 2.0, accuracy: 0.01, "Medium elevation should have Y offset of 2.0")
    }
    ...
    func testElevationLevelHighShadowYOffset() {
        ...
        XCTAssertEqual(yOffset, 4.0, accuracy: 0.01, "High elevation should have Y offset of 4.0")
    }
    ...
    func testElevationLevelNoneAccessibilityLabel() {
        ...
        XCTAssertEqual(
            label, "Flat card", "Elevation.none should have accessibility label 'Flat card'")
    }
    ...
    func testElevationLevelLowAccessibilityLabel() {
        ...
        // Then: It should describe the level
        XCTAssertEqual(
            label, "Card with subtle elevation",
    ...
    func testElevationLevelMediumAccessibilityLabel() {
        ...
        // Then: It should describe the level
        XCTAssertEqual(
            label, "Card with medium elevation",
    ...
    func testElevationLevelHighAccessibilityLabel() {
        ...
        // Then: It should describe the level
        XCTAssertEqual(
            label, "Card with high elevation",
    ...
    func testCardStyleUsesDesignSystemRadiusTokens() {
        ...
        XCTAssertEqual(
            DS.Radius.card, 10.0, accuracy: 0.01, "Card style should use DS.Radius.card token")

        // Small radius should use DS.Radius.small
        XCTAssertEqual(
            DS.Radius.small, 6.0, accuracy: 0.01, "Card style should support DS.Radius.small token")
    }
    ...
    func testCardElevationAllCasesExist() {
        ...
        XCTAssertEqual(allCases.count, 4, "CardElevation should have exactly 4 cases")
