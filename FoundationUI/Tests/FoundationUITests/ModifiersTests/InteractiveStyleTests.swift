...
@MainActor final class InteractiveStyleTests: XCTestCase {
    ...
    func testInteractionTypeNoneHasNoEffect() {
        ...
        XCTAssertFalse(hasEffect, "InteractionType.none should not apply any interaction effects")
    }
    ...
    func testInteractionTypeSubtleHasEffect() {
        ...
        XCTAssertTrue(hasEffect, "InteractionType.subtle should apply subtle interaction effects")
    }
    ...
    func testInteractionTypeStandardHasEffect() {
        ...
        // Then: It should have effect
        XCTAssertTrue(
            hasEffect, "InteractionType.standard should apply standard interaction effects")
    }
    ...
    func testInteractionTypeProminentHasEffect() {
        ...
        // Then: It should have effect
        XCTAssertTrue(
            hasEffect, "InteractionType.prominent should apply prominent interaction effects")
    }
    ...
    func testInteractionTypeNoneScaleFactor() {
        ...
        XCTAssertEqual(
            scaleFactor, 1.0, accuracy: 0.001,
    ...
    func testInteractionTypeSubtleScaleFactor() {
        ...
        XCTAssertEqual(
            scaleFactor, 1.02, accuracy: 0.001,
    ...
    func testInteractionTypeStandardScaleFactor() {
        ...
        XCTAssertEqual(
            scaleFactor, 1.05, accuracy: 0.001,
    ...
    func testInteractionTypeProminentScaleFactor() {
        ...
        XCTAssertEqual(
            scaleFactor, 1.08, accuracy: 0.001,
    ...
    func testInteractionTypeSubtleOpacity() {
        ...
        XCTAssertEqual(
            opacity, 0.95, accuracy: 0.001, "InteractionType.subtle should have opacity of 0.95")
    }
    ...
    func testInteractionTypeStandardOpacity() {
        ...
        XCTAssertEqual(
            opacity, 0.9, accuracy: 0.001, "InteractionType.standard should have opacity of 0.9")
    }
    ...
    func testInteractionTypeProminentOpacity() {
        ...
        XCTAssertEqual(
            opacity, 0.85, accuracy: 0.001, "InteractionType.prominent should have opacity of 0.85")
    }
    ...
    func testInteractionTypeNoneAccessibilityHint() {
        ...
        XCTAssertEqual(hint, "", "InteractionType.none should have no accessibility hint")
    }
    ...
    func testInteractionTypeSubtleAccessibilityHint() {
        ...
        XCTAssertEqual(
            hint, "Interactive element with subtle feedback",
    ...
    func testInteractionTypeProminentAccessibilityHint() {
        ...
        XCTAssertEqual(
            hint, "Primary interactive element with prominent feedback",
    ...
    func testInteractionTypeSupportsKeyboardFocus() {
        ...
        for type in types {
            XCTAssertTrue(type.supportsKeyboardFocus, "\(type) should support keyboard focus")
        }
    }
    ...
    func testInteractionTypeAllCasesExist() {
        ...
        XCTAssertEqual(allCases.count, 4, "InteractionType should have exactly 4 cases")
    ...
    func testInteractionTypeUsesQuickAnimation() {
        ...
        for type in types { XCTAssertNotNil(type) }
    }
}
