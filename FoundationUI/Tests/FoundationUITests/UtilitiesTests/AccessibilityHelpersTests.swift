...
import XCTest
    ...
    @MainActor final class AccessibilityHelpersTests: XCTestCase {
        ...
        func testContrastRatioCalculation() {
            ...
            XCTAssertGreaterThan(
                blackWhiteRatio, 20.0, "Black on white should have contrast ratio ≥21:1")

            // White on black should also have maximum contrast
            let whiteBlackRatio = AccessibilityHelpers.contrastRatio(
                foreground: .white, background: .black)
            XCTAssertGreaterThan(
                whiteBlackRatio, 20.0, "White on black should have contrast ratio ≥21:1")
        }
        ...
        func testContrastRatioWCAG_AA_Compliance() {
            ...
            let lightGrayOnWhite = AccessibilityHelpers.meetsWCAG_AA(
                foreground: Color.gray.opacity(0.3), background: .white)
        ...
        func testContrastRatioWithDSColors() {
            ...
            let warnBGContrast = AccessibilityHelpers.contrastRatio(
                foreground: .black, background: DS.Colors.warnBG)
        ...
        func testVoiceOverHintForToggle() {
            let expandHint = AccessibilityHelpers.voiceOverHint(action: "expand", target: "section")
            ...
            let collapseHint = AccessibilityHelpers.voiceOverHint(
                action: "collapse", target: "section")
        ...
        func testAccessibleButtonModifier() {
            ...
            let view = Text("Test")
            let accessibleView = view.accessibleButton(label: "Test Button", hint: "Tap to test")
        ...
        func testAccessibleToggleModifier() {
            ...
            let accessibleToggle = view.accessibleToggle(label: "Test Toggle", isOn: true)
        ...
        func testAccessibleValueModifier() {
            ...
            let view = Text("12345")
            let accessibleValue = view.accessibleValue(label: "Count", value: "12345")
        ...
        func testAccessibilityAuditFailures() {
            ...
            let auditResult = AccessibilityHelpers.auditView(
                hasLabel: false, hasHint: false, touchTargetSize: CGSize(width: 20, height: 20),
                contrastRatio: 2.0)
        ...
        func testDynamicTypeScaling() {
            ...
            let scaledSize = AccessibilityHelpers.scaledValue(baseSize, for: .xxLarge)
        ...
        func testAccessibilityContextIntegration() {
            ...
            let context = AccessibilityContext(
                prefersReducedMotion: true, prefersIncreasedContrast: true, prefersBoldText: true,
            ...
            XCTAssertGreaterThan(
                preferredSpacing, DS.Spacing.m, "Should increase spacing for contrast")
        }
        ...
        func testContrastRatioPerformance() {
            ...
            measure {
                for _ in 0..<1000 {
                    _ = AccessibilityHelpers.contrastRatio(foreground: .black, background: .white)
                }
            }
        }
