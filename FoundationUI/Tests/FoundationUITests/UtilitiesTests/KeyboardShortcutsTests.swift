...
@testable import FoundationUI
    ...
    /// - View integration
    @available(iOS 17.0, macOS 14.0, *) @MainActor final class KeyboardShortcutsTests: XCTestCase {
        ...
        func testKeyboardShortcutType_AllStandardShortcuts_AreDefined() {
            ...
            let shortcuts: [KeyboardShortcutType] = [
                .copy, .paste, .cut, .selectAll, .undo, .redo, .save, .find, .newItem, .close,
                .refresh,
            ]
        ...
        func testKeyboardShortcutType_AccessibilityLabel_AllShortcuts_HaveLabels() {
            let shortcuts: [KeyboardShortcutType] = [.copy, .paste, .cut, .selectAll]
        ...
        func testViewExtension_Shortcut_CanBeApplied() {
            struct TestView: View {
                ...
                var body: some View { Text("Test").shortcut(.copy) { actionTriggered = true } }
            }
