// swift-tools-version: 6.0
    ...
    @MainActor final class NavigationScaffoldIntegrationTests: XCTestCase {
        ...
        func testSidebarPatternAccessesNavigationModelFromEnvironment() {
            ...
            let scaffold = NavigationSplitScaffold(model: model) {
                List { Text("Sidebar Item") }.accessibilityIdentifier("TestSidebar")
            } content: {
                Text("Content")
            } detail: {
                Text("Detail")
        ...
        func testSidebarPatternWorksStandaloneWithoutNavigationModel() {
            ...
            let sections: [SidebarPattern<TestID, Text>.Section] = [
                .init(title: "Test", items: [.init(id: UUID(), title: "Item 1")])
            ]
        ...
        func testInspectorPatternAccessesNavigationModelFromEnvironment() {
            ...
            let scaffold = NavigationSplitScaffold(model: model) {
                ...
                InspectorPattern(title: "Inspector") { Text("Inspector content") }
            }
        ...
        func testFullThreePatternComposition() {
            ...
            let sections: [SidebarPattern<TestID, AnyView>.Section] = [
                .init(title: "Files", items: [.init(id: UUID(), title: "sample.mp4")])
            ]
            ...
            let scaffold = NavigationSplitScaffold(model: model) {
                ...
                InspectorPattern(title: "Properties") { Text("Atom details") }
            }
        ...
        func testScaffoldWithSidebarAndInspectorPatterns() {
            ...
            let sections: [SidebarPattern<TestID, AnyView>.Section] = [
                .init(
                    title: "Recent",
                    items: [.init(id: "file1", title: "sample.mp4", iconSystemName: "doc.fill")])
            ]
        ...
        func testIndependentScaffoldsHaveIndependentModels() {
            ...
            XCTAssertNotEqual(
                scaffold1.navigationModel.columnVisibility,
                scaffold2.navigationModel.columnVisibility)
        }
        ...
        func testCompactSizeClassBehaviorWithPatterns() {
            ...
            let scaffold = NavigationSplitScaffold(model: model) {
                SidebarPattern(sections: sections, selection: .constant(nil)) { _ in Text("Detail")
                }
            } content: {
                Text("Content")
            } detail: {
        ...
        func testRegularSizeClassBehaviorWithPatterns() {
            ...
            let scaffold = NavigationSplitScaffold(model: model) {
                ...
                InspectorPattern(title: "Inspector") { Text("Details") }
            }
        ...
        func testAccessibilityLabelsPreservedInScaffold() {
            ...
            let scaffold = NavigationSplitScaffold(model: model) {
                ...
                Text("Content").accessibilityLabel("Parse Tree")
            } detail: {
                InspectorPattern(title: "Properties") { Text("Details") }.accessibilityLabel(
                    "Atom Inspector")
            }
        ...
        func testPatternsWorkWithoutScaffold() {
            ...
            let sidebar = SidebarPattern(sections: sidebarSections, selection: .constant(nil)) {
                _ in Text("Detail")
            }

            // InspectorPattern standalone
            let inspector = InspectorPattern(title: "Inspector") { Text("Content") }
        ...
        func testPatternsWorkInsideScaffold() {
            ...
            let scaffold = NavigationSplitScaffold(model: model) {
                ...
                InspectorPattern(title: "Inspector") { Text("Content") }
            }
        ...
        func testEmptyPatternComposition() {
            ...
            let scaffold = NavigationSplitScaffold(model: model) {
                SidebarPattern(sections: sections, selection: .constant(nil)) { _ in EmptyView() }
            } content: {
                EmptyView()
            } detail: {
                EmptyView()
                ...
                var body: some View {
                    VStack {
                        if navigationModel != nil {
                            InspectorPattern(title: "Nested") { Text("Nested content") }
                        } else {
                            Text("No model")
                        }
                    }
