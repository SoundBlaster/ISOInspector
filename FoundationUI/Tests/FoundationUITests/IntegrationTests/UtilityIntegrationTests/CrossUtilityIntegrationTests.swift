...
final class CrossUtilityIntegrationTests: XCTestCase {
    ...
    func testCopyableTextWithAccessibilityHelpers() {
        ...
        XCTAssertTrue(audit.passes || !audit.issues.isEmpty, "Accessibility audit should run on CopyableText")
    }
    ...
    func testAccessibilityHelpersWithKeyboardShortcuts() {
        ...
        XCTAssertFalse(accessibilityLabel.isEmpty, "Keyboard shortcuts should have accessibility labels")
