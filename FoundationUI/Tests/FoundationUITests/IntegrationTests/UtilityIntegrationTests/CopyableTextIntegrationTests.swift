...
import XCTest
    ...
    @MainActor final class CopyableTextIntegrationTests: XCTestCase {
        ...
        func testCopyableTextWithinCard() {
            ...
            let card = Card {
                VStack(spacing: DS.Spacing.m) {
                    Text("Card Title").font(DS.Typography.headline)
        ...
        func testCopyableTextWithinKeyValueRow() {
            ...
            let row = KeyValueRow(key: "Memory Address", value: "0xDEADBEEF", copyable: true)
        ...
        func testCopyableTextWithLongContent() {
            ...
            let longText =
                "This is a very long text value that might need to wrap or truncate depending on the container width and layout constraints"
        ...
        func testCopyableTextPerformanceInList() {
            ...
            measure {
                _ = ForEach(0..<100, id: \.self) { index in CopyableText(text: "Item \(index)") }
            }
        }
