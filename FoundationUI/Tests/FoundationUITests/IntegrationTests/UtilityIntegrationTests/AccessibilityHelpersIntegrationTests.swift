...
import XCTest
    ...
    @MainActor final class AccessibilityHelpersIntegrationTests: XCTestCase {
        ...
        func testContrastValidationOnBadgeErrorColor() {
            ...
            let contrastRatio = AccessibilityHelpers.contrastRatio(
                foreground: .black, background: DS.Colors.errorBG)
        ...
        func testContrastValidationOnBadgeSuccessColor() {
            ...
            let contrastRatio = AccessibilityHelpers.contrastRatio(
                foreground: .black, background: DS.Colors.successBG)
        ...
        func testContrastValidationOnCardBackgrounds() {
            ...
            let card = Card { Text("Sample Content") }
        ...
        func testVoiceOverHintsWithBadgeComponent() {
            ...
            let hint = AccessibilityHelpers.voiceOverHint(action: "view details", target: "badge")
        ...
        func testVoiceOverHintsWithKeyValueRowActions() {
            ...
            let copyHint = AccessibilityHelpers.voiceOverHint(action: "copy", target: "value")
        ...
        func testAccessibleButtonModifierOnRealButton() {
            ...
            let button = Button("Copy") {}.accessibleButton(
                label: "Copy Value", hint: "Copies the value to clipboard")
        ...
        func testAccessibleHeadingModifierOnSectionHeaders() {
            ...
            let header = Text("Inspector Details").accessibleHeading(level: 1)
        ...
        func testAccessibleValueModifierOnKeyValueRow() {
            ...
            let row = Text("12345").accessibleValue(label: "Item Count", value: "12345")
        ...
        // MARK: - Platform-Specific Integration
            ...
            func testMacOSKeyboardNavigationAccessibility() {
                ...
                let view = Text("Navigate Me").macOSKeyboardNavigable()
            ...
            func testIOSVoiceOverRotorAccessibility() {
                ...
                let view = Text("Rotor Item").voiceOverRotor(entry: "Actions")
