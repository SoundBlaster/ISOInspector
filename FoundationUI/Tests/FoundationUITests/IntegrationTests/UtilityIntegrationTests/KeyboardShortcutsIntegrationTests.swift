...
import XCTest
    ...
    @MainActor final class KeyboardShortcutsIntegrationTests: XCTestCase {
        ...
        func testStandardShortcutsInToolbar() {
            ...
            let shortcuts = [
                KeyboardShortcutType.copy, KeyboardShortcutType.paste, KeyboardShortcutType.cut,
        ...
        // MARK: - Platform-Specific Modifier Tests
            ...
            func testKeyboardShortcutsUseCommandKeyOnMacOS() {
                ...
                XCTAssertTrue(
                    copyShortcut.displayString.contains("⌘"), "Should use Command symbol on macOS")
            }
        #endif
            ...
            func testKeyboardShortcutsUseControlKeyOnNonMacOS() {
                ...
                XCTAssertTrue(
                    copyShortcut.displayString.contains("Ctrl"), "Should use Control on non-macOS")
            }
        #endif
        ...
        func testKeyboardShortcutDisplayStringsInUI() {
            ...
            let shortcuts = [
                KeyboardShortcutType.copy, KeyboardShortcutType.paste, KeyboardShortcutType.cut,
                KeyboardShortcutType.save, KeyboardShortcutType.undo, KeyboardShortcutType.redo,
            ]
        ...
        func testDisplayStringsUsePlatformAppropriateFormatting() {
            ...
            #else
                XCTAssertTrue(
                    copyShortcut.displayString.contains("Ctrl")
                        || copyShortcut.displayString.contains("⌃"),
                    "Non-macOS should use Ctrl or ⌃")
            #endif
        }
        ...
        func testMultipleShortcutsOnSameScreen() {
            ...
            let shortcuts = [
                KeyboardShortcutType.copy, KeyboardShortcutType.paste, KeyboardShortcutType.cut,
                KeyboardShortcutType.selectAll, KeyboardShortcutType.save,
            ]

            // All shortcuts should be distinct
            let displayStrings = Set(shortcuts.map(\.displayString))
            XCTAssertEqual(
                displayStrings.count, shortcuts.count, "All shortcuts should be distinct")
        }
        ...
        func testCustomShortcutIntegration() {
            ...
            XCTAssertNotNil(
                KeyboardShortcutType.copy, "Standard shortcuts serve as template for custom ones")
        }
        ...
        func testKeyboardShortcutLabelsUseDSTypography() {
            ...
            let shortcutLabel = Text(KeyboardShortcutType.copy.displayString).font(
                DS.Typography.caption)
