...
@testable import FoundationUI
    ...
    @MainActor final class CopyableArchitectureIntegrationTests: XCTestCase {
        ...
        func testCopyableModifierAsFoundation() {
            ...
            let view = Text("Foundation").copyable(text: "Foundation")
        ...
        func testCopyableWrapperUsesCopyableModifier() {
            ...
            let copyable = Copyable(text: "Test") { Text("Test") }
        ...
        func testExistingCopyableTextUsageContinuesWorking() {
            ...
            // In Card
            let inCard = Card { VStack { CopyableText(text: "0x1234ABCD") } }
        ...
        func testCopyableModifierWithBadge() {
            ...
            let view = Badge(text: "Info", level: .info).copyable(text: "Info badge")
        ...
        func testCopyableModifierWithCard() {
            ...
            let view = Card { Text("Card content") }.copyable(text: "Card content")
        ...
        func testCopyableModifierWithKeyValueRow() {
            ...
            let view = KeyValueRow(key: "Key", value: "Value").copyable(text: "Value")
        ...
        func testCopyableModifierWithSectionHeader() {
            ...
            let view = SectionHeader(title: "Section").copyable(text: "Section")
        ...
        func testCopyableWrapperWithBadge() {
            ...
            let copyable = Copyable(text: "Badge") { Badge(text: "Info", level: .info) }
        ...
        func testCopyableWrapperWithCard() {
            ...
            let copyable = Copyable(text: "Card") { Card { Text("Content") } }
        ...
        func testCopyableWrapperWithKeyValueRow() {
            ...
            let copyable = Copyable(text: "Value") { KeyValueRow(key: "Key", value: "Value") }
        ...
        func testMixedCopyableTypesOnSameScreen() {
            ...
            let view = VStack {
                ...
                // Modifier
                Text("Modifier").copyable(text: "Modifier")

                // Wrapper
                Copyable(text: "Wrapper") { Text("Wrapper") }
            }
        ...
        func testNestedCopyableInCard() {
            ...
            let view = Card {
                VStack {
                    ...
                    Copyable(text: "Nested 2") { Text("Nested 2") }
                }
            }
        ...
        func testCopyableInInspectorPattern() {
            ...
            let view = InspectorPattern(title: "Inspector") {
                VStack {
                    ...
                    Copyable(text: "Value") { KeyValueRow(key: "Key", value: "Value") }
                }
            }
        ...
        func testMixedFeedbackSettings() {
            ...
            let view = VStack {
                Text("With feedback").copyable(text: "With feedback", showFeedback: true)

                Text("Without feedback").copyable(text: "Without feedback", showFeedback: false)

                Copyable(text: "Wrapper with feedback", showFeedback: true) { Text("Wrapper") }

                Copyable(text: "Wrapper without feedback", showFeedback: false) { Text("Wrapper") }
            }
        ...
        func testCopyableAccessibilityLabels() {
            ...
            let modifier = Text("Value").copyable(text: "Value")
            XCTAssertNotNil(modifier)

            let wrapper = Copyable(text: "Value") { Text("Value") }
        ...
        func testCopyableWithDynamicType() {
            ...
            let view = VStack {
                CopyableText(text: "Dynamic Type").dynamicTypeSize(.xSmall)

                CopyableText(text: "Dynamic Type").dynamicTypeSize(.large)

                CopyableText(text: "Dynamic Type").dynamicTypeSize(.xxxLarge)
            }
        ...
        // MARK: - Platform-Specific Integration
            ...
            func testMacOSKeyboardShortcuts() {
                ...
                let wrapper = Copyable(text: "macOS") { Text("macOS") }
        ...
        func testISOInspectorMetadataView() {
            ...
            let view = Card {
                VStack(alignment: .leading, spacing: DS.Spacing.m) {
                    ...
                    KeyValueRow(key: "Size", value: "0x00000018").copyable(text: "0x00000018")
        ...
        func testHexValueDisplay() {
            ...
            let view = Copyable(text: "0x1A2B3C4D") {
                HStack(spacing: DS.Spacing.s) {
                    Image(systemName: "number").foregroundColor(DS.Colors.accent)
        ...
        func testPerformanceWithManyCopyableElements() {
            ...
            measure {
                let view = VStack {
                    ForEach(0..<100, id: \.self) { i in CopyableText(text: "Item \(i)") }
                }
        ...
        func testGradualMigrationFromCopyableText() {
            ...
            let migrated = Text("Value").font(DS.Typography.code).copyable(text: "Value")
        ...
        func testAllCopyableVariantsUseDSTokens() {
            ...
            let wrapper = Copyable(text: "DS Tokens") { Text("DS Tokens") }
        ...
        func testCopyableWithEmptyStringsAcrossVariants() {
            ...
            let wrapper = Copyable(text: "") { Text("Empty") }
        ...
        func testCopyableWithSpecialCharactersAcrossVariants() {
            ...
            let wrapper = Copyable(text: specialChars) { Text("Special") }
        ...
        func testCopyableComposesWithAllModifiers() {
            ...
            let view = Text("Composed").font(DS.Typography.code).foregroundColor(DS.Colors.accent)
        ...
        func testCopyableInComplexHierarchy() {
            ...
            let view = Card {
                VStack { HStack { VStack { Text("Nested").copyable(text: "Nested") } } }
            }
