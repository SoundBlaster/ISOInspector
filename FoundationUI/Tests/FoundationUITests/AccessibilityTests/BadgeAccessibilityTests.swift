...
@MainActor final class BadgeAccessibilityTests: XCTestCase {
    ...
    func testBadgeInfoLevelHasCorrectAccessibilityLabel() {
        ...
        // Then
        XCTAssertEqual(
            level.accessibilityLabel, "Information",
    ...
    func testBadgeWarningLevelHasCorrectAccessibilityLabel() {
        ...
        // Then
        XCTAssertEqual(
            level.accessibilityLabel, "Warning",
    ...
    func testBadgeErrorLevelHasCorrectAccessibilityLabel() {
        ...
        // Then
        XCTAssertEqual(
            level.accessibilityLabel, "Error",
    ...
    func testBadgeSuccessLevelHasCorrectAccessibilityLabel() {
        ...
        // Then
        XCTAssertEqual(
            level.accessibilityLabel, "Success",
    ...
    func testAllBadgeLevelsHaveAccessibilityLabels() {
        ...
        for level in allLevels {
            AccessibilityTestHelpers.assertValidAccessibilityLabel(
                level.accessibilityLabel, context: "Badge level '\(level)'")
        }
    }
    ...
    func testBadgeInfoLevelHasAppropriateIcon() {
        ...
        // Then
        XCTAssertEqual(
            level.iconName, "info.circle.fill", "Info badge should use info.circle.fill SF Symbol")
    }
    ...
    func testBadgeWarningLevelHasAppropriateIcon() {
        ...
        // Then
        XCTAssertEqual(
            level.iconName, "exclamationmark.triangle.fill",
    ...
    func testBadgeErrorLevelHasAppropriateIcon() {
        ...
        // Then
        XCTAssertEqual(
            level.iconName, "xmark.circle.fill",
    ...
    func testBadgeSuccessLevelHasAppropriateIcon() {
        ...
        // Then
        XCTAssertEqual(
            level.iconName, "checkmark.circle.fill",
    ...
    func testAllBadgeLevelsHaveIcons() {
        ...
        for level in allLevels {
            XCTAssertFalse(
                level.iconName.isEmpty, "Badge level '\(level)' should have an icon name")
        }
    }
    ...
    func testBadgeUsesDesignSystemColors() {
        ...
        XCTAssertEqual(
            infoLevel.backgroundColor, DS.Colors.infoBG,
            "Info badge should use DS.Colors.infoBG token")
        XCTAssertEqual(
            warningLevel.backgroundColor, DS.Colors.warnBG,
            "Warning badge should use DS.Colors.warnBG token")
        XCTAssertEqual(
            errorLevel.backgroundColor, DS.Colors.errorBG,
            "Error badge should use DS.Colors.errorBG token")
        XCTAssertEqual(
            successLevel.backgroundColor, DS.Colors.successBG,
    ...
    func testBadgeMinimumTouchTargetSize() {
        ...
        XCTAssertGreaterThan(
            horizontalPadding, 0, "Badge should have horizontal padding for better touch target")
        XCTAssertGreaterThan(
            verticalPadding, 0, "Badge should have vertical padding for better touch target")
    ...
    func testBadgeComponentWithIconPreservesAccessibility() {
        ...
        // Then
        XCTAssertTrue(badge.showIcon, "Badge with icon should set showIcon property")
        XCTAssertEqual(
            badge.level.accessibilityLabel, "Warning",
            "Badge with icon should preserve accessibility label")
        XCTAssertEqual(
            badge.level.iconName, "exclamationmark.triangle.fill",
    ...
    func testBadgeWithEmptyTextStillHasAccessibilityLabel() {
        ...
        AccessibilityTestHelpers.assertValidAccessibilityLabel(
            badge.level.accessibilityLabel, context: "Badge with empty text")
    }
    ...
    func testBadgeWithNilTextFallsBackToLevelAccessibility() {
        ...
        // Then
        AccessibilityTestHelpers.assertValidAccessibilityLabel(
            badge.level.accessibilityLabel, context: "Badge with nil text")
        XCTAssertTrue(
