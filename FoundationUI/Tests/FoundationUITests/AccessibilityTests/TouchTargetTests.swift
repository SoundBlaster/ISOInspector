...
@testable import FoundationUI
    ...
    /// - iPadOS 17.0+
    /// - macOS 14.0+
    @MainActor final class TouchTargetTests: XCTestCase {
        ...
        func testInteractiveStyle_MeetsMinimumTouchTarget() {
            ...
            let buttonSize = CGSize(
                width: Self.minimumTouchTargetSize, height: Self.minimumTouchTargetSize)

            let meetsRequirement =
                buttonSize.width >= Self.minimumTouchTargetSize
        ...
        func testBadgeChipStyle_SufficientTouchArea() {
            ...
            let meetsRequirement =
                badgeSize.width >= Self.minimumTouchTargetSize
        ...
        func testCardComponent_TappableTouchTarget() {
            ...
            let cardSize = CGSize(width: 300.0, height: 100.0)

            let meetsRequirement =
                cardSize.width >= Self.minimumTouchTargetSize
                && cardSize.height >= Self.minimumTouchTargetSize

            XCTAssertTrue(meetsRequirement, "Tappable Cards exceed minimum touch target size")
        }
        ...
        func testCopyableText_ButtonTouchTarget() {
            ...
            let meetsRequirement =
                copyButtonSize.width >= Self.minimumTouchTargetSize
        ...
        func testToolbarPattern_ToolbarItems_MeetMinimum() {
            ...
            let meetsRequirement =
                toolbarItemSize.width >= Self.minimumTouchTargetSize
        ...
        func testSidebarPattern_ListItemTouchTarget() {
            ...
            let meetsRequirement =
                listItemSize.width >= Self.minimumTouchTargetSize
        ...
        func testBoxTreePattern_TreeNodeTouchTarget() {
            ...
            let nodeSize = CGSize(width: 250.0, height: nodeHeight)

            let meetsRequirement =
                nodeSize.width >= Self.minimumTouchTargetSize
        ...
        func testBoxTreePattern_ExpandCollapseButton_TouchTarget() {
            ...
            let meetsRequirement =
                disclosureButtonSize.width >= Self.minimumTouchTargetSize
        ...
        func testInspectorPattern_InteractiveElements_TouchTarget() {
            ...
            let meetsRequirement =
                inspectorButtonSize.width >= Self.minimumTouchTargetSize
        ...
        func testMinimumSizeEdgeCase_ExactlyMinimum() {
            ...
            let meetsRequirement =
                exactMinimumSize.width >= Self.minimumTouchTargetSize
        ...
        func testMinimumSizeEdgeCase_OneLessThanMinimum() {
            ...
            let tooSmallSize = CGSize(
                width: Self.minimumTouchTargetSize - 1.0, height: Self.minimumTouchTargetSize)

            let meetsRequirement =
                tooSmallSize.width >= Self.minimumTouchTargetSize
                && tooSmallSize.height >= Self.minimumTouchTargetSize

            XCTAssertFalse(
                meetsRequirement, "Size one point less than minimum should fail validation")
        }
        ...
        func testMinimumSizeEdgeCase_AsymmetricSize() {
            ...
            let asymmetricSize = CGSize(
                width: Self.minimumTouchTargetSize, height: Self.minimumTouchTargetSize - 5.0)

            let meetsRequirement =
                asymmetricSize.width >= Self.minimumTouchTargetSize
                && asymmetricSize.height >= Self.minimumTouchTargetSize

            XCTAssertFalse(meetsRequirement, "Asymmetric size with insufficient height should fail")
        }
        ...
        func testTouchTargets_MaintainSizeWithDynamicType() {
            ...
            for size in accessibilitySizes {
                ...
                XCTAssertTrue(meetsRequirement, "Touch targets maintain minimum size at \(size)")
            }
        }
        ...
        func testComprehensiveTouchTargetAudit() {
            ...
            let components: [(name: String, size: CGSize)] = [
                ...
                (
                    "CopyableText button",
                    CGSize(width: Self.minimumTouchTargetSize, height: Self.minimumTouchTargetSize)
                ),
                (
                    "Toolbar item",
                    CGSize(width: Self.minimumTouchTargetSize, height: Self.minimumTouchTargetSize)
            ...
            for component in components {
                let meets =
                    component.size.width >= Self.minimumTouchTargetSize
                ...
                if meets {
                    ...
                    failed += 1
                    issues.append(
                        "\(component.name): \(component.size.width)×\(component.size.height) pt (required ≥\(Self.minimumTouchTargetSize)×\(Self.minimumTouchTargetSize) pt)"
                    )
                }
            }
