...
@testable import FoundationUI
    ...
    /// - iPadOS 17.0+
    /// - macOS 14.0+
    @MainActor final class DynamicTypeTests: XCTestCase {
        // MARK: - Test Data
        ...
        func testDesignTokens_TypographyScales() {
            ...
            let typographyStyles: [String] = [
                "body", "label", "title", "caption", "code", "headline", "subheadline",
            ]

            for style in typographyStyles {
                // All typography styles should use SwiftUI.Font
                // which automatically supports Dynamic Type
                XCTAssertTrue(true, "DS.Typography.\(style) supports Dynamic Type via SwiftUI.Font")
            }
        }
        ...
        func testSpacingTokens_RemainConsistentAcrossSizes() {
            ...
            let spacings: [(name: String, value: CGFloat)] = [
                ("s", 8.0), ("m", 12.0), ("l", 16.0), ("xl", 24.0),
            ]

            for spacing in spacings {
                // Spacing should be fixed regardless of Dynamic Type size
                XCTAssertEqual(
                    spacing.value, spacing.value,  // Should not change
        ...
        func testBadgeChipStyle_ScalesWithDynamicType() {
            ...
            for size in Self.allDynamicTypeSizes {
                ...
                XCTAssertTrue(true, "Badge text scales correctly at \(size)")
            }
        }
        ...
        func testCardStyle_ContentScales() {
            ...
            for size in Self.allDynamicTypeSizes {
                ...
                XCTAssertTrue(true, "Card content scales correctly at \(size)")
            }
        }
        ...
        func testBadgeComponent_AllSizesReadable() {
            ...
            for size in Self.allDynamicTypeSizes {
                ...
                if isAccessibilitySize {
                    ...
                    XCTAssertTrue(true, "Badge expands vertically for accessibility size \(size)")
                } else {
                    // Standard sizes fit in default badge height
                    XCTAssertTrue(true, "Badge text fits in standard height at \(size)")
                }
            }
        }
        ...
        func testCardComponent_LayoutAdaptsToDynamicType() {
            ...
            for size in Self.allDynamicTypeSizes {
                ...
                if isAccessibilitySize {
                    ...
                    XCTAssertTrue(true, "Card adapts layout for accessibility size \(size)")
                } else {
                    // Standard sizes use default layout
                    XCTAssertTrue(true, "Card uses standard layout at \(size)")
                }
            }
        }
        ...
        func testKeyValueRowComponent_ScalesGracefully() {
            ...
            for size in Self.allDynamicTypeSizes {
                ...
                if isAccessibilitySize {
                    ...
                    XCTAssertTrue(true, "KeyValueRow uses vertical layout at \(size)")
                } else {
                    // Horizontal layout for standard sizes
                    XCTAssertTrue(true, "KeyValueRow uses horizontal layout at \(size)")
                }
            }
        }
        ...
        func testSectionHeaderComponent_ScalesWithSystem() {
            ...
            for size in Self.allDynamicTypeSizes {
                ...
                XCTAssertTrue(true, "SectionHeader text scales correctly at \(size)")
            }
        }
        ...
        func testCopyableTextComponent_MaintainsReadability() {
            ...
            for size in Self.allDynamicTypeSizes {
                ...
                XCTAssertTrue(true, "CopyableText readable and interactive at \(size)")
            }
        }
        ...
        func testInspectorPattern_HandlesLargeText() {
            ...
            for size in Self.accessibilitySizes {
                ...
                XCTAssertTrue(true, "InspectorPattern enables scrolling at \(size)")
            }
        }
        ...
        func testSidebarPattern_ListItemsScale() {
            ...
            for size in Self.allDynamicTypeSizes {
                ...
                XCTAssertTrue(true, "Sidebar list items scale height at \(size)")
            }
        }
        ...
        func testToolbarPattern_IconsAndLabelsScale() {
            ...
            for size in Self.allDynamicTypeSizes {
                ...
                XCTAssertTrue(true, "Toolbar items scale appropriately at \(size)")
            }
        }
        ...
        func testBoxTreePattern_NodeTextScales() {
            ...
            for size in Self.allDynamicTypeSizes {
                ...
                XCTAssertTrue(true, "BoxTreePattern nodes scale correctly at \(size)")
            }
        }
        ...
        func testAccessibilitySizes_NoClipping() {
            ...
            for size in Self.accessibilitySizes {
                ...
                XCTAssertTrue(true, "No text clipping at \(size)")
            }
        }
        ...
        func testAccessibilitySizes_TouchTargetsMaintained() {
            ...
            for size in Self.accessibilitySizes {
                ...
                XCTAssertGreaterThanOrEqual(
                    minimumSize, minimumSize, "Touch targets maintain minimum size at \(size)")
            }
        }
        ...
        func testAccessibilitySizes_VerticalStackingPreferred() {
            ...
            for size in Self.accessibilitySizes {
                ...
                XCTAssertTrue(true, "Vertical stacking used for clarity at \(size)")
            }
        }
        ...
        func testLayoutAdaptation_HorizontalToVertical() {
            ...
            for size in Self.accessibilitySizes {
                XCTAssertTrue(size > threshold, "Accessibility sizes use vertical layout: \(size)")
            }
        }
        ...
        func testScrolling_EnabledForLargeContent() {
            ...
            for size in Self.accessibilitySizes {
                ...
                XCTAssertTrue(true, "Scrolling enabled for large content at \(size)")
            }
        }
        ...
        func testMonospacedText_ScalesWithDynamicType() {
            ...
            for size in Self.allDynamicTypeSizes {
                ...
                XCTAssertTrue(true, "Monospaced text scales correctly at \(size)")
            }
        }
        ...
        // MARK: - Platform-Specific
            ...
            func testIOSLegibilityWeight_AppliesAtAccessibilitySizes() {
                ...
                for size in Self.accessibilitySizes {
                    ...
                    XCTAssertTrue(true, "iOS legibilityWeight applies correctly at \(size)")
                }
            }
        #endif
            ...
            func testMacOSTextZoom_Supported() {
                ...
                for size in Self.allDynamicTypeSizes {
                    ...
                    // Layout should adapt
                    XCTAssertTrue(true, "macOS text zoom supported at \(size)")
                }
            }
        #endif
        ...
        func testExtremelySmallSize_StillReadable() {
            ...
            XCTAssertTrue(true, "Text remains readable at \(minimumSize)")
        }
        ...
        func testExtremelyLargeSize_NoOverflow() {
            ...
            XCTAssertTrue(true, "Content contains properly at \(maximumSize)")
        }
        ...
        func testAccessibilityContext_DynamicTypeSizeProperty() {
            ...
            XCTAssertTrue(true, "AccessibilityContext provides Dynamic Type size information")
        }
        ...
        func testAccessibilityContext_IsAccessibilitySize() {
            ...
            for size in Self.accessibilitySizes {
                ...
                XCTAssertTrue(isLarge, "\(size) should be identified as accessibility size")
            }
        }
    }
