...
@MainActor final class SectionHeaderAccessibilityTests: XCTestCase {
    ...
    func testSectionHeaderHasHeaderTrait() {
        ...
        XCTAssertNotNil(header, "SectionHeader should apply .isHeader accessibility trait")
    }
    ...
    func testSectionHeaderWithDividerHasHeaderTrait() {
        ...
        XCTAssertTrue(header.showDivider, "SectionHeader with divider should maintain header trait")
    }
    ...
    func testSectionHeaderPreservesTitleText() {
        ...
        // Then
        XCTAssertEqual(header.title, title, "SectionHeader should preserve original title text")
    }
    ...
    func testSectionHeaderWithUppercaseTitle() {
        ...
        // Then
        XCTAssertEqual(header.title, title, "SectionHeader should preserve uppercase title")
    }
    ...
    func testSectionHeaderWithMixedCaseTitle() {
        ...
        XCTAssertEqual(header.title, title, "SectionHeader should preserve mixed case title")
    }
    ...
    func testSectionHeaderTitleIsNotEmpty() {
        ...
        AccessibilityTestHelpers.assertValidAccessibilityLabel(
            header.title, context: "SectionHeader title")
    }
    ...
    func testSectionHeaderWithEmptyTitle() {
        ...
        XCTAssertEqual(header.title, "", "SectionHeader should accept empty title")
    }
    ...
    func testSectionHeaderWithSpecialCharacters() {
        ...
        // Then
        XCTAssertEqual(header.title, title, "SectionHeader should support special characters")
    }

    func testSectionHeaderWithLongTitle() {
        // Given
        let longTitle =
            "This is a very long section header title that might wrap across multiple lines"
    ...
    func testSectionHeaderWithoutDivider() {
        ...
        // Then
        XCTAssertFalse(
            header.showDivider, "SectionHeader should not show divider when showDivider is false")
    }
    ...
    func testSectionHeaderWithDivider() {
        ...
        // Then
        XCTAssertTrue(
            header.showDivider, "SectionHeader should show divider when showDivider is true")
    }
    ...
    func testSectionHeaderDividerIsDecorativeForAccessibility() {
        ...
        XCTAssertEqual(
            headerWithDivider.title, headerWithoutDivider.title,
    ...
    func testSectionHeaderUsesDesignSystemSpacing() {
        ...
        XCTAssertGreaterThan(DS.Spacing.s, 0, "SectionHeader should use DS.Spacing.s (must be > 0)")
    }
    ...
    func testSectionHeaderUsesDesignSystemTypography() {
        ...
        XCTAssertNotNil(captionFont, "SectionHeader should use DS.Typography.caption")
    }
    ...
    func testSectionHeaderTextMeetsContrastRequirements() {
        ...
        XCTAssertNotNil(
            foreground, "SectionHeader should use .secondary color (WCAG compliant by system)")
    }
    ...
    func testSectionHeaderOnCurrentPlatform() {
        ...
        // Then
        XCTAssertNotNil(header, "SectionHeader should be creatable on \(platform)")
    }
    ...
    func testSectionHeaderDefaultBehavior() {
        ...
        // Then
        XCTAssertFalse(
            header.showDivider, "SectionHeader should have showDivider = false by default")
    }
    ...
    func testMultipleSectionHeadersHaveUniqueContent() {
        ...
        // Then
        XCTAssertNotEqual(
            header1.title, header2.title, "Different section headers should have different titles")
        XCTAssertNotEqual(
    ...
    func testSectionHeaderProvidesHeadingSemantics() {
        ...
        XCTAssertNotNil(
            header.title, "SectionHeader with .isHeader trait provides heading navigation")
    }
    ...
    func testSectionHeaderInListContext() {
        ...
        for header in headers {
            AccessibilityTestHelpers.assertValidAccessibilityLabel(
                header.title, context: "SectionHeader in list")
        }
    }
}
