...
@testable import FoundationUI
  ...
  final class VoiceOverTests: XCTestCase {
    ...
    func testInteractiveStyle_HasAccessibilityLabel() {
      ...
      XCTAssertFalse(
        label.isEmpty,
        "Interactive elements must have non-empty accessibility labels"
      )
    }
    ...
    func testCopyableModifier_HasDescriptiveLabels() {
      ...
      XCTAssertTrue(
        copyHint.lowercased().contains("copy") || copyHint.lowercased().contains("clipboard"),
    ...
    func testBadgeComponent_AccessibilityLabel() {
      ...
      XCTAssertTrue(
        expectedLabel.contains(badgeText),
        "Badge label should include text (\(badgeText))"
      )
    }
    ...
    func testCardComponent_AccessibilityRole() {
      ...
      XCTAssertFalse(
        interactiveCardLabel.isEmpty,
        "Interactive cards must have labels"
      )

      XCTAssertFalse(
        staticCardLabel.isEmpty,
        "Static cards should have labels for VoiceOver navigation"
      )
    }
    ...
    func testKeyValueRowComponent_AccessibilityLabels() {
      ...
      XCTAssertFalse(
        expectedLabel.isEmpty,
        "KeyValueRow must have combined accessibility label"
      )
    ...
    func testSectionHeaderComponent_AccessibilityTraits() {
      ...
      XCTAssertTrue(
        hasHeaderTrait,
        "SectionHeader must have .isHeader accessibility trait"
      )

      XCTAssertFalse(
        headerText.isEmpty,
        "SectionHeader must have non-empty text for VoiceOver"
      )
    }
    ...
    func testCopyableTextComponent_VoiceOverAnnouncements() {
      ...
      XCTAssertFalse(
        copyButtonLabel.isEmpty,
        "Copy button must have label"
      )
    ...
    func testInspectorPattern_SectionAccessibility() {
      ...
      XCTAssertTrue(
        hasHeaderTrait,
        "Inspector section headers should have .isHeader trait"
      )

      XCTAssertFalse(
        sectionTitle.isEmpty,
        "Section headers must have descriptive text"
      )
    }
    ...
    func testInspectorPattern_NavigationAccessibility() {
      ...
      XCTAssertFalse(
        inspectorLabel.isEmpty,
        "Inspector should have accessibility label"
      )
    ...
    func testSidebarPattern_ListItemAccessibility() {
      ...
      XCTAssertFalse(
        itemLabel.isEmpty,
        "Sidebar items must have labels"
      )
    ...
    func testSidebarPattern_NavigationHints() {
      ...
      XCTAssertFalse(
        sidebarLabel.isEmpty,
        "Sidebar should have accessibility label"
      )
    ...
    func testToolbarPattern_ItemAccessibility() {
      ...
      XCTAssertFalse(
        copyItemLabel.isEmpty,
        "Toolbar items must have labels"
      )
    ...
    func testToolbarPattern_OverflowMenuAccessibility() {
      ...
      XCTAssertFalse(
        overflowLabel.isEmpty,
        "Overflow menu button must have label"
      )
    ...
    func testBoxTreePattern_SelectionAccessibility() {
      ...
      XCTAssertTrue(
        selectedLabel.contains("selected"),
        "Selected nodes should announce selection state"
      )
    ...
    func testVoiceOverHints_UseActionVerbs() {
      ...
      for hint in goodHints {
        ...
        XCTAssertTrue(
          containsActionVerb,
          "VoiceOver hint '\(hint)' should contain action verb"
        )
      }
    }
    ...
    func testVoiceOverHints_Concise() {
      ...
      let hints = [
        "Double tap to copy value to clipboard",
    ...
    func testVoiceOverLabels_Descriptive() {
      ...
      for label in goodLabels {
        XCTAssertGreaterThan(
          label.count,
          3,
          "VoiceOver label should be descriptive: '\(label)'"
        )

        XCTAssertLessThan(
          label.count,
          50,
          "VoiceOver label should not be verbose: '\(label)'"
        )
      }
    }
    ...
    func testAccessibilityHelpers_VoiceOverHintBuilder() {
      ...
      XCTAssertFalse(
        hint.isEmpty,
        "AccessibilityHelpers should generate non-empty hints"
      )
    ...
    func testAccessibilityHelpers_ButtonLabel() {
      ...
      XCTAssertFalse(
        label.isEmpty,
        ".accessibleButton should require non-empty label"
      )
    ...
    func testComprehensiveVoiceOverAudit() {
      ...
      for component in components {
        ...
        let hasRequiredAttributes = component.hasLabel && (component.hasHint || !component.hasTrait)
        ...
        if hasRequiredAttributes {
          ...
          failed += 1
          let missing = [
            component.hasLabel ? nil : "label",
            component.hasHint ? nil : "hint",
    ...
    func testDynamicContent_AnnouncesChanges() {
      ...
      XCTAssertFalse(
        updateAnnouncement.isEmpty,
        "Dynamic content changes should announce updates"
      )
