...
//
  ...
  final class ComponentAgentDescribableTests: XCTestCase {
    ...
    func testKeyValueRowComponentType() {
      ...
      XCTAssertEqual(
        row.componentType, "KeyValueRow", "KeyValueRow should have componentType 'KeyValueRow'"
      )
    }
    ...
    func testSectionHeaderDefaultDivider() {
      ...
      XCTAssertEqual(
        header.properties["showDivider"] as? Bool, false, "Default showDivider should be false"
      )
    }
