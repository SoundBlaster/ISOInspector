    ...
    ///
    @available(iOS 17.0, macOS 14.0, *) @MainActor final class YAMLViewGeneratorTests: XCTestCase {
        ...
        func testGenerateBadgeWithInvalidLevel() {
            let description = YAMLParser.ComponentDescription(
                componentType: "Badge", properties: ["text": "Test", "level": "invalid-level"])
        ...
        func testGeneratePerformance() {
            ...
            measure { _ = try? YAMLViewGenerator.generateView(fromYAML: yaml) }
        }
    ...
    @available(iOS 17.0, macOS 14.0, *) final class YAMLViewGeneratorTests: XCTestCase {
