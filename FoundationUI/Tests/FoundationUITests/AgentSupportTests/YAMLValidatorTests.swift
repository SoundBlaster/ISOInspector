...
///
@available(iOS 17.0, macOS 14.0, *) final class YAMLValidatorTests: XCTestCase {
    // MARK: - Valid Component Tests

    func testValidateBadge() throws {
        let description = YAMLParser.ComponentDescription(
            componentType: "Badge", properties: ["text": "Test", "level": "info", "showIcon": true])
    ...
    func testValidateCard() throws {
        let description = YAMLParser.ComponentDescription(
            componentType: "Card",
            properties: ["elevation": "medium", "cornerRadius": 12, "material": "regular"])
    ...
    func testValidateKeyValueRow() throws {
        let description = YAMLParser.ComponentDescription(
            ...
            properties: [
                "key": "Size", "value": "1024 bytes", "layout": "horizontal", "isCopyable": true,
            ])
    ...
    func testValidateSectionHeader() throws {
        let description = YAMLParser.ComponentDescription(
            componentType: "SectionHeader", properties: ["title": "Metadata", "showDivider": true])
    ...
    func testValidateInspectorPattern() throws {
        let description = YAMLParser.ComponentDescription(
            ...
            properties: ["title": "Inspector", "material": "thick"])
    ...
    func testRejectUnknownComponentType() {
        let description = YAMLParser.ComponentDescription(
            componentType: "UnknownComponent", properties: [:])
    ...
    func testRejectBadgeMissingText() {
        let description = YAMLParser.ComponentDescription(
            componentType: "Badge", properties: ["level": "info"])
    ...
    func testRejectBadgeMissingLevel() {
        let description = YAMLParser.ComponentDescription(
            componentType: "Badge", properties: ["text": "Test"])
    ...
    func testRejectKeyValueRowMissingKey() {
        let description = YAMLParser.ComponentDescription(
            componentType: "KeyValueRow", properties: ["value": "1024"])
    ...
    func testRejectInvalidBoolType() {
        let description = YAMLParser.ComponentDescription(
            componentType: "Badge",
            properties: [
                "text": "Test", "level": "info", "showIcon": "true",  // Should be Bool
            ])
    ...
    func testRejectInvalidBadgeLevel() {
        let description = YAMLParser.ComponentDescription(
            componentType: "Badge", properties: ["text": "Test", "level": "invalid"])
    ...
    func testRejectInvalidElevation() {
        let description = YAMLParser.ComponentDescription(
            componentType: "Card", properties: ["elevation": "super-high"])
    ...
    func testRejectInvalidMaterial() {
        let description = YAMLParser.ComponentDescription(
            componentType: "Card", properties: ["material": "plastic"])
    ...
    func testRejectCornerRadiusTooHigh() {
        let description = YAMLParser.ComponentDescription(
            componentType: "Card", properties: ["cornerRadius": 100])
    ...
    func testRejectNegativeCornerRadius() {
        let description = YAMLParser.ComponentDescription(
            componentType: "Card", properties: ["cornerRadius": -5])
    ...
    func testAcceptValidCornerRadius() throws {
        let description = YAMLParser.ComponentDescription(
            componentType: "Card", properties: ["cornerRadius": 12])
    ...
    func testSuggestTypoCorrection() {
        let description = YAMLParser.ComponentDescription(
            componentType: "Badge",
            properties: [
                "text": "Test", "level": "erro",  // Should be "error"
            ])
    ...
    func testSuggestWarningTypo() {
        let description = YAMLParser.ComponentDescription(
            componentType: "Badge",
            properties: [
                "text": "Test", "level": "waring",  // Should be "warning"
            ])
    ...
    func testValidateNestedComponents() throws {
        let nestedBadge = YAMLParser.ComponentDescription(
            componentType: "Badge", properties: ["text": "Nested", "level": "success"])

        let card = YAMLParser.ComponentDescription(
            componentType: "Card", properties: ["elevation": "low"], content: [nestedBadge])
    ...
    func testRejectInvalidNestedComponent() {
        let invalidBadge = YAMLParser.ComponentDescription(
            componentType: "Badge",
            properties: [
                "text": "Invalid"// Missing required "level" property
            ])

        let card = YAMLParser.ComponentDescription(
            componentType: "Card", properties: [:], content: [invalidBadge])
    ...
    func testRejectExcessiveNesting() {
        ...
        var current = YAMLParser.ComponentDescription(
            componentType: "Badge", properties: ["text": "Deep", "level": "info"])

        for _ in 0..<20 {
            current = YAMLParser.ComponentDescription(
                componentType: "Card", properties: [:], content: [current])
        }
    ...
    func testAcceptReasonableNesting() throws {
        ...
        var current = YAMLParser.ComponentDescription(
            componentType: "Badge", properties: ["text": "Moderate", "level": "info"])
    ...
    func testValidateMultipleComponents() throws {
        let descriptions = [
            YAMLParser.ComponentDescription(
                componentType: "Badge", properties: ["text": "Test1", "level": "info"]),
            YAMLParser.ComponentDescription(
                componentType: "Badge", properties: ["text": "Test2", "level": "warning"]),
            YAMLParser.ComponentDescription(
                componentType: "Badge", properties: ["text": "Test3", "level": "error"]),
        ]
    ...
    func testRejectMultipleComponentsWithInvalid() {
        let descriptions = [
            YAMLParser.ComponentDescription(
                componentType: "Badge", properties: ["text": "Valid", "level": "info"]),
            YAMLParser.ComponentDescription(
                componentType: "Badge", properties: ["text": "Invalid", "level": "invalid-level"]),
            YAMLParser.ComponentDescription(
                componentType: "Badge", properties: ["text": "Valid2", "level": "success"]),
        ]
    ...
    func testAcceptMissingOptionalProperties() throws {
        let description = YAMLParser.ComponentDescription(
            componentType: "Badge",
            properties: [
                "text": "Test", "level": "info",// showIcon is optional, not provided
            ])
    ...
    func testAcceptCardWithoutOptionalProperties() throws {
        let description = YAMLParser.ComponentDescription(
            componentType: "Card", properties: [:]  // All Card properties are optional
        )
