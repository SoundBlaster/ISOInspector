...
//
    ...
    @available(iOS 17.0, macOS 14.0, *) @MainActor final class AgentDescribableTests: XCTestCase {
        ...
        func testComponentTypeReturnsCorrectIdentifier() {
            ...
            XCTAssertEqual(
                componentType, "MockComponent", "componentType should match component name")
        }
        ...
        func testPropertiesDictionaryContainsExpectedValues() {
            ...
            XCTAssertEqual(
                properties["title"] as? String, "Test Title", "title should be 'Test Title'")
        ...
        func testSemanticsProvidesMeaningfulDescription() {
            ...
            XCTAssertTrue(
                semantics.count > 10, "semantics should be a meaningful description (>10 chars)")
    ...
    private struct MockDescribableComponent: AgentDescribable {
        ...
        var properties: [String: Any] { ["title": "Test Title", "isEnabled": true] }

        var semantics: String { "A test component for verifying AgentDescribable protocol" }
    }
    ...
    private struct AnotherMockDescribableComponent: AgentDescribable {
        ...
        var properties: [String: Any] { ["value": 42, "color": "blue"] }

        var semantics: String { "Another test component" }
    }
    ...
    private struct MockDescribableStruct: AgentDescribable {
        ...
        var properties: [String: Any] { ["text": text, "level": level] }

        var semantics: String { "A struct-based test component" }
    }
