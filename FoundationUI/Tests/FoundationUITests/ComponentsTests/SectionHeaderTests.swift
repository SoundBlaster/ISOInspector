...
@MainActor final class SectionHeaderTests: XCTestCase {
    ...
    func testSectionHeaderInitializationWithoutDivider() {
        ...
        XCTAssertEqual(header.title, title, "SectionHeader title should match initialization value")
        XCTAssertFalse(
            header.showDivider, "SectionHeader should not show divider when explicitly disabled")
    }
    ...
    func testSectionHeaderPreservesTitle() {
        // Given
        let testCases = [
            "File Properties", "Metadata", "Box Structure", "Technical Details",
            "Basic Information", "",  // Edge case: empty title
    ...
    func testSectionHeaderWithSpecialCharacters() {
        ...
        // Then
        XCTAssertEqual(
            header.title, specialTitle,
            "SectionHeader should support special characters and Unicode")
    }
    ...
    func testSectionHeaderWithWhitespace() {
        ...
        // Then
        XCTAssertEqual(
            header.title, titleWithSpaces, "SectionHeader should preserve whitespace in title")
    }
    ...
    func testMultipleSectionHeadersWithDifferentConfigurations() {
        ...
        let headers = [
            ...
            SectionHeader(title: "Second", showDivider: false), SectionHeader(title: "Third"),
