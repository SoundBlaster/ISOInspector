...
@testable import FoundationUI
    ...
    @MainActor final class CopyableTests: XCTestCase {
        ...
        func testCopyableWithFeedbackParameter() {
            ...
            let copyable = Copyable(text: "Test", showFeedback: true) { Text("Test") }
        ...
        func testCopyableWithoutFeedback() {
            ...
            let copyable = Copyable(text: "Test", showFeedback: false) { Text("Test") }
        ...
        func testCopyableWithConditionalContent() {
            ...
            let copyable = Copyable(text: "Conditional") {
                if showIcon { Image(systemName: "doc.text") }
                Text("Conditional")
            }
        ...
        func testCopyableConformsToView() {
            ...
            let copyable = Copyable(text: "View Test") { Text("View Test") }
        ...
        func testCopyableWithTextContent() {
            ...
            let copyable = Copyable(text: "Text Content") { Text("Text Content") }
        ...
        func testCopyableWithImageContent() {
            ...
            let copyable = Copyable(text: "Image Content") { Image(systemName: "doc.text") }
        ...
        func testCopyableWithCardContent() {
            ...
            let copyable = Copyable(text: "Card Content") { Card { Text("Card content") } }
        ...
        func testCopyableWithEmptyString() {
            ...
            let copyable = Copyable(text: "") { Text("Empty text") }
        ...
        func testCopyableWithVeryLongString() {
            ...
            let copyable = Copyable(text: longText) { Text("Long text") }
        ...
        func testCopyableWithSpecialCharacters() {
            ...
            let copyable = Copyable(text: specialText) { Text("Special") }
        ...
        func testCopyableWithMultilineText() {
            ...
            let multilineText = """
                ...
                Line 3
                """
            let copyable = Copyable(text: multilineText) { Text("Multiline") }
        ...
        func testCopyableUsesDesignSystemTokens() {
            ...
            let copyable = Copyable(text: "DS Tokens") { Text("DS Tokens") }
        ...
        func testCopyableWithStyledContent() {
            ...
            let copyable = Copyable(text: "Styled") {
                Text("Styled").font(DS.Typography.code).foregroundColor(DS.Colors.accent)
            }
        ...
        func testCopyablePerformance() {
            ...
            measure {
                for _ in 0..<100 {
                    _ = Copyable(text: "Performance Test \(UUID())") { Text("Performance Test") }
                }
        ...
        func testCopyableWithFileInfo() {
            ...
            let copyable = Copyable(text: "Document.pdf") {
                HStack(spacing: DS.Spacing.s) {
                    Image(systemName: "doc.text.fill").foregroundColor(DS.Colors.secondary)
                    VStack(alignment: .leading, spacing: DS.Spacing.s) {
                        Text("Document.pdf").font(DS.Typography.body)
                        Text("2.5 MB").font(DS.Typography.caption).foregroundColor(
        ...
        func testCopyableWithBadgeAndIcon() {
            ...
            let copyable = Copyable(text: "Status: Active") {
                HStack(spacing: DS.Spacing.s) {
                    Image(systemName: "checkmark.circle.fill").foregroundColor(DS.Colors.successBG)
