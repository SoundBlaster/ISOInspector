...
final class IndicatorTests: XCTestCase {
    ...
    func testIndicatorSizeMappingsUseDesignTokens() {
        // Then
        XCTAssertEqual(Indicator.Size.mini.diameter, DS.Spacing.s, "Mini indicator should use DS.Spacing.s")
        XCTAssertEqual(Indicator.Size.small.diameter, DS.Spacing.m, "Small indicator should use DS.Spacing.m")
        XCTAssertEqual(Indicator.Size.medium.diameter, DS.Spacing.l, "Medium indicator should use DS.Spacing.l")
    }
    ...
    func testTooltipPrefersBadgeContentWhenRequested() {
        ...
        default:
            XCTFail("Expected badge tooltip content")
        }
    }
    ...
    func testTooltipConvertsTextToBadgeWhenPreferred() {
        ...
        default:
            XCTFail("Expected badge tooltip content when badge style is preferred")
        }
    }
