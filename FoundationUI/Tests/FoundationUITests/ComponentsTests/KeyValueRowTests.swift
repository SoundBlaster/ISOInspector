...
@MainActor final class KeyValueRowTests: XCTestCase {
    ...
    func testKeyValueRowKeyContent() {
        // Given
        let testCases = [
            ("Type", "ftyp"), ("Size", "1024"), ("Offset", "0x00001234"), ("", "value"),  // Edge case: empty key
    ...
    func testKeyValueRowValueContent() {
        // Given
        let testCases = [
            ("Type", "ftyp"), ("Size", "1024"), ("Offset", "0x00001234"), ("key", ""),  // Edge case: empty value
            ("hex", "0xDEADBEEF"),
        ]
