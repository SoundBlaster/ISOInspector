...
final class KeyValueRowTests: XCTestCase {
    ...
    func testKeyValueRowWithLongValue() {
        // Given
        let longValue = "This is a very long value that might wrap or truncate and should ideally use vertical layout"
    ...
    func testKeyValueRowWithSpecialCharacters() {
        ...
        XCTAssertEqual(row.value, value, "KeyValueRow should support special characters and Unicode in value")
    }
