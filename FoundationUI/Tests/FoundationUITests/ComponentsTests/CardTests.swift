...
@MainActor final class CardTests: XCTestCase {
    ...
    func testCardInitializationWithCustomCornerRadius() {
        // Given
        let radiusValues: [CGFloat] = [DS.Radius.small, DS.Radius.medium, DS.Radius.card]

        // When & Then
        for radius in radiusValues {
            let card = Card(cornerRadius: radius) { Text("Content") }
    ...
    func testCardInitializationWithMaterial() {
        // Given & When
        let cardWithMaterial = Card(material: .thin) { Text("With Material") }

        let cardWithoutMaterial = Card(material: nil) { Text("Without Material") }
    ...
    func testCardInitializationWithAllParameters() {
        ...
        // When
        let card = Card(elevation: elevation, cornerRadius: radius, material: material) {
            VStack {
                Text("Title")
                Text("Content")
            }
    ...
    func testCardSupportsAllElevationLevels() {
        ...
        // When & Then
        for level in levels {
            let card = Card(elevation: level) { Text("Test") }
    ...
    func testCardDefaultElevationIsMedium() {
        // Given
        let defaultCard = Card { Text("Default") }
    ...
    func testCardUsesDesignSystemRadiusTokens() {
        ...
        let radiusTokens: [(String, CGFloat)] = [
            ("small", DS.Radius.small), ("medium", DS.Radius.medium), ("card", DS.Radius.card),
        ]
    ...
    func testCardSupportsAllMaterialTypes() {
        // Given
        let materials: [Material?] = [nil, .thin, .regular, .thick, .ultraThin, .ultraThick]

        // When & Then
        for material in materials {
            let card = Card(material: material) { Text("Content") }
    ...
    func testCardUsesOnlyDesignSystemTokens() {
        ...
        // When
        let card = Card(cornerRadius: validRadius) { Text("Content") }
    ...
    func testCardMaintainsAccessibilityForContent() {
        // Given & When
        let card = Card { Text("Accessible Content").accessibilityLabel("Custom Label") }
    ...
    func testCardWithZeroCornerRadius() {
        ...
        // When
        let card = Card(cornerRadius: radius) { Text("Sharp Corners") }
    ...
    func testCardWithVeryLargeCornerRadius() {
        ...
        // When
        let card = Card(cornerRadius: radius) { Text("Capsule Shape") }
