...
public struct BoxTreePattern<ID: Hashable>: View {
    ...
    @State private var controllerIdentity: UUID

    private let nodesInput: [BoxTreeNode<ID>]
    private let allowsMultipleSelectionInput: Bool
    ...
    public init(
        ...
        _controllerIdentity = State(initialValue: UUID())
        nodesInput = nodes
        allowsMultipleSelectionInput = allowsMultipleSelection
    }
    ...
    public var body: some View {
        ...
        .onChange(of: nodesInput) { newNodes in
            rebuildController(nodes: newNodes, allowsMultipleSelection: allowsMultipleSelectionInput)
        }
        .onChange(of: allowsMultipleSelectionInput) { newValue in
            rebuildController(nodes: nodesInput, allowsMultipleSelection: newValue)
        }
