            ...
            return [
                SidebarPattern.Section(
                    ...
                    items: [
                        ...
                        .init(id: UUID(), title: "Structure", iconSystemName: "square.grid.3x3"),
        ...
        private let sections = [
            ...
            SidebarPattern.Section(
                ...
                items: [
                    ...
                    .init(id: "export", title: "Export Data", iconSystemName: "square.and.arrow.up")
                ]
            )
        ]
        ...
        private let sections = [
            SidebarPattern.Section(
                ...
                items: [
                    ...
                    .init(id: 2, title: "moov", iconSystemName: "film", accessibilityLabel: "Movie Box"),
                ...
                SidebarPattern(
                    sections: [
                        .init(
                            title: "Platform Info",
                            items: [
                                .init(id: UUID(), title: "Current Platform", iconSystemName: "display")
                            ]
                        )
                    ],
                    selection: $selection
                    ...
                    InspectorPattern(title: "Platform Details") {
                        ...
                        KeyValueRow(key: "Min Width", value: "DS.Spacing.l * 10 + DS.Spacing.xl * 2")
                        #else
