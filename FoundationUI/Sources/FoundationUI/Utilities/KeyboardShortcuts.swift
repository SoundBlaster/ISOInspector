...
#Preview("Platform Modifiers") {
    VStack(spacing: DS.Spacing.l) {
        Text("Platform-Specific Modifiers")
            .font(DS.Typography.title)
            .padding(.bottom, DS.Spacing.m)
        ...
        VStack(alignment: .leading, spacing: DS.Spacing.s) {
            ...
            Text("• macOS uses Command (⌘) as primary modifier")
                .font(DS.Typography.caption)

            Text("• Other platforms use Control (Ctrl)")
                .font(DS.Typography.caption)

            Text("• Shortcuts automatically adapt to platform")
                .font(DS.Typography.caption)
        }
...
#Preview("Interactive Shortcuts") {
    VStack(spacing: DS.Spacing.l) {
        Text("Interactive Shortcut Demo")
            .font(DS.Typography.title)
            .padding(.bottom, DS.Spacing.m)

        Text("Try using keyboard shortcuts:")
            .font(DS.Typography.body)
        ...
        Group {
            ...
            .shortcut(.copy) {
                print("Shortcut triggered: Copy")
            }

            Button("Paste Text") {
                print("Button clicked: Paste")
            }
            .buttonStyle(.bordered)
            .shortcut(.paste) {
                print("Shortcut triggered: Paste")
            }

            Button("Save Document") {
                print("Button clicked: Save")
            }
            .buttonStyle(.borderedProminent)
            .shortcut(.save) {
                print("Shortcut triggered: Save")
            }
        }
        ...
        VStack(alignment: .leading, spacing: DS.Spacing.s) {
            ...
            Text("• Shortcuts announced to VoiceOver users")
                .font(DS.Typography.caption)

            Text("• Hardware keyboard required on iOS")
                .font(DS.Typography.caption)

            Text("• All platforms support keyboard navigation")
                .font(DS.Typography.caption)
        }
        .padding(DS.Spacing.m)
        .background(DS.Colors.successBG)
