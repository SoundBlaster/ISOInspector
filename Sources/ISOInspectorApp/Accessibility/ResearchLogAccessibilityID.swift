    ...
    enum ResearchLogAccessibilityID {
        ...
        enum Header {
            ...
            enum MissingFixture { static let details = "details" }

            enum LoadFailure { static let message = "message" }
        }
        ...
        static func path(_ components: String...) -> String { components.joined(separator: ".") }
    }
#endif
