...
final class RandomAccessPayloadAnnotationProvider: PayloadAnnotationProvider {
  ...
  func annotations(for header: BoxHeader) async throws -> [PayloadAnnotation] {
    ...
    case "ftyp":
      annotations.append(
        contentsOf: try parseFileTypeBox(header: header, start: payloadStart, end: payloadEnd))
    case "mvhd":
      annotations.append(
        contentsOf: try parseMovieHeaderBox(header: header, start: payloadStart, end: payloadEnd))
    default:
      break
    }
