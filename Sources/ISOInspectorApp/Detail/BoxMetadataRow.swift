...
public struct BoxMetadataRow: View {
    ...
    public init(
        label: String, value: String, layout: KeyValueLayout = .horizontal, copyable: Bool = false
    ) {
        self.label = label
        self.value = value
        self.layout = layout
    ...
    public var body: some View {
        KeyValueRow(key: label, value: value, layout: layout, copyable: copyable)
    }
}
...
#Preview("BoxMetadataRow - Vertical Layout") {
    VStack(alignment: .leading, spacing: DS.Spacing.l) {
        BoxMetadataRow(
            ...
            layout: .vertical)
        BoxMetadataRow(
            label: "Full Path", value: "/Users/username/Documents/Projects/ISOInspector/test.iso",
            layout: .vertical)
    }.padding()
}
...
#Preview("BoxMetadataRow - Dark Mode") {
    VStack(alignment: .leading, spacing: DS.Spacing.m) {
        BoxMetadataRow(label: "Type", value: "ftyp", copyable: true)
        BoxMetadataRow(
            label: "Description", value: "Long description in dark mode", layout: .vertical)
        BoxMetadataRow(label: "Offset", value: "0x00001234", copyable: true)
    ...
    ScrollView {
        VStack(alignment: .leading, spacing: DS.Spacing.l) {
            ...
            VStack(alignment: .leading, spacing: DS.Spacing.m) {
                ...
                BoxMetadataRow(
                    label: "Compatible Brands", value: "isom, iso2, avc1, mp41", layout: .vertical,
                    copyable: true)
            }
        }.padding()
    }
...
@available(iOS 17.0, macOS 14.0, *) @MainActor extension BoxMetadataRow: AgentDescribable {
    public var componentType: String { "BoxMetadataRow" }

    public var properties: [String: Any] {
        [
            "label": label, "value": value,
            "layout": layout == .horizontal ? "horizontal" : "vertical", "copyable": copyable,
        ]
    }
