    ...
    public struct UserPreferences: Codable, Equatable, Sendable {
        ...
        public init(
            validationPresetID: String = "default", validationRuleOverrides: [String: Bool] = [:],
            telemetryVerbosity: Int = 0, loggingVerbosity: Int = 2,
            reduceMotionOverride: Bool? = nil, experimentalFeatures: [String] = [],
