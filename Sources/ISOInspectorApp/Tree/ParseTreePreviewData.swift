      ...
      let moov = makeNode(
        ...
        children: [
          makeNode(
            ...
            issues: [
              ValidationIssue(
                ruleID: "VR-TRAK", message: "Track missing language", severity: .warning)
            ],
            children: [
              makeNode(
                type: "mdia", start: 600,
                  ...
                  makeNode(
                    ...
                    children: [
                      makeNode(
                        ...
                        issues: [
                          ValidationIssue(
                            ruleID: "VR-STBL", message: "Index error", severity: .error)
                        ])
                    ])
                ])
            ]),
  ...
  extension ParseIssue.Severity {
    fileprivate init(_ validationSeverity: ValidationIssue.Severity) {
