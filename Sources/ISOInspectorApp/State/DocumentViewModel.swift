...
final class DocumentViewModel: ObservableObject {
    struct ValidationSummary: Equatable {
        ...
        static func make(from snapshot: ParseTreeSnapshot) -> ValidationSummary {
            ...
            return ValidationSummary(errorCount: errors, warningCount: warnings, infoCount: infos)
        }
    }
    ...
    init(
        ...
        let resolvedDetail = detailViewModel
        ...
        self.nodeViewModel = NodeSelectionViewModel(
            outlineViewModel: resolvedOutline,
            detailViewModel: resolvedDetail,
        ...
        self.exportAvailability = ExportAvailability(
            canExportDocument: !store.snapshot.nodes.isEmpty,
    ...
    private func setupBindings() {
        ...
        nodeViewModel.selectionPublisher
            .sink { [weak self] _ in
