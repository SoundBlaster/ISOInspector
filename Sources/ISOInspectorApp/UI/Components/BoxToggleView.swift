    ...
    @MainActor public struct BoxToggleView: View {
        // MARK: - Properties
        ...
        public init(
            isOn: Binding<Bool>, label: String, disabled: Bool = false,
        ...
        public var body: some View {
            ...
            Toggle(isOn: $isOn) { Text(label) }.disabled(disabled).accessibilityLabel(
                effectiveAccessibilityLabel)
        }

        // MARK: - Private Helpers

        private var effectiveAccessibilityLabel: String { accessibilityLabel ?? label }
    }
    ...
    #Preview("Toggle States") {
        VStack(alignment: .leading, spacing: DS.Spacing.l) {
            BoxToggleView(isOn: .constant(true), label: "Enabled toggle")

            BoxToggleView(isOn: .constant(false), label: "Disabled toggle", disabled: true)

            BoxToggleView(
                isOn: .constant(true), label: "With custom accessibility",
