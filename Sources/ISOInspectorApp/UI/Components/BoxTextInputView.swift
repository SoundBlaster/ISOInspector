    ...
    @MainActor public struct BoxTextInputView: View {
        // MARK: - Properties
        ...
        public init(
            text: Binding<String>, placeholder: String = "", validationError: String? = nil,
        ...
        private var textField: some View {
            let field = TextField(placeholder, text: $text, onEditingChanged: onEditingChanged)
            #if os(iOS)
                return field.keyboardType(keyboardType.uiKeyboardType).textFieldStyle(
                    .roundedBorder
                ).overlay(
        ...
        private func errorLabel(_ message: String) -> some View {
            Text(message).font(.caption).foregroundColor(.red).accessibilityLabel(
                "Error: \(message)")
        }
    }
    ...
    #Preview("Text Input States") {
        VStack(alignment: .leading, spacing: DS.Spacing.xl) {
            BoxTextInputView(text: .constant(""), placeholder: "Enter box name...")

            BoxTextInputView(text: .constant("ftyp"), placeholder: "Enter box name...")
            ...
            BoxTextInputView(
                text: .constant(""), placeholder: "Enter offset...", keyboardType: .numberPad)
        }.padding()
    }
