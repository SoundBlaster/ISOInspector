...
public struct ParsedBoxPayload: Equatable, Sendable {
    ...
    public struct FileTypeBox: Equatable, Sendable {
        ...
        public init(
            majorBrand: FourCharCode, minorVersion: UInt32, compatibleBrands: [FourCharCode]
        ) {
    ...
    public struct MediaDataBox: Equatable, Sendable {
        ...
        public init(
            headerStartOffset: Int64, headerEndOffset: Int64, totalSize: Int64,
        ...
        public var payloadLength: Int64 {
            max(0, payloadRange.upperBound - payloadRange.lowerBound)
        }
    ...
    public struct PaddingBox: Equatable, Sendable {
        ...
        public init(
            type: FourCharCode, headerStartOffset: Int64, headerEndOffset: Int64, totalSize: Int64,
            payloadRange: Range<Int64>
        ) {
            self.type = type
            self.headerStartOffset = headerStartOffset
    ...
    public struct TransformationMatrix: Equatable, Sendable {
        ...
        public static let identity = TransformationMatrix(
            a: 1.0, b: 0.0, u: 0.0, c: 0.0, d: 1.0, v: 0.0, x: 0.0, y: 0.0, w: 1.0)
    }
    ...
    public struct MovieHeaderBox: Equatable, Sendable {
        ...
        public init(
            version: UInt8, creationTime: UInt64, modificationTime: UInt64, timescale: UInt32,
            duration: UInt64, durationIs64Bit: Bool, rate: Double, volume: Double,
            matrix: TransformationMatrix, nextTrackID: UInt32
        ) {
    ...
    public struct TrackHeaderBox: Equatable, Sendable {
        ...
        public init(
            version: UInt8, flags: UInt32, creationTime: UInt64, modificationTime: UInt64,
            trackID: UInt32, duration: UInt64, durationIs64Bit: Bool, layer: Int16,
            alternateGroup: Int16, volume: Double, matrix: TransformationMatrix, width: Double,
            height: Double, isEnabled: Bool, isInMovie: Bool, isInPreview: Bool
        ) {
            self.version = version
            self.flags = flags
            self.creationTime = creationTime
    ...
    public struct TrackExtendsDefaultsBox: Equatable, Sendable {
        ...
        public init(
            version: UInt8, flags: UInt32, trackID: UInt32, defaultSampleDescriptionIndex: UInt32,
            defaultSampleDuration: UInt32, defaultSampleSize: UInt32, defaultSampleFlags: UInt32
        ) {
            self.version = version
            self.flags = flags
            self.trackID = trackID
    ...
    public struct TrackFragmentHeaderBox: Equatable, Sendable {
        ...
        public init(
            version: UInt8, flags: UInt32, trackID: UInt32, baseDataOffset: UInt64?,
            sampleDescriptionIndex: UInt32?, defaultSampleDuration: UInt32?,
            defaultSampleSize: UInt32?, defaultSampleFlags: UInt32?, durationIsEmpty: Bool,
    ...
    public struct TrackFragmentDecodeTimeBox: Equatable, Sendable {
        ...
        public init(
            version: UInt8, flags: UInt32, baseMediaDecodeTime: UInt64,
    ...
    public struct TrackRunBox: Equatable, Sendable {
        public struct Entry: Equatable, Sendable {
            ...
            public init(
                index: UInt32, decodeTime: UInt64?, presentationTime: Int64?,
                sampleDuration: UInt32?, sampleSize: UInt32?, sampleFlags: UInt32?,
                sampleCompositionTimeOffset: Int32?, dataOffset: UInt64?, byteRange: Range<Int64>?
            ) {
                self.index = index
        ...
        public init(
            version: UInt8, flags: UInt32, sampleCount: UInt32, dataOffset: Int32?,
            firstSampleFlags: UInt32?, entries: [Entry], totalSampleDuration: UInt64?,
            totalSampleSize: UInt64?, startDecodeTime: UInt64?, endDecodeTime: UInt64?,
            startPresentationTime: Int64?, endPresentationTime: Int64?, startDataOffset: UInt64?,
            endDataOffset: UInt64?, trackID: UInt32?, sampleDescriptionIndex: UInt32?,
            runIndex: UInt32?, firstSampleGlobalIndex: UInt64?
        ) {
            self.version = version
            self.flags = flags
    ...
    public struct SampleEncryptionBox: Equatable, Sendable {
        ...
        public init(
            version: UInt8, flags: UInt32, sampleCount: UInt32, algorithmIdentifier: UInt32?,
            perSampleIVSize: UInt8?, keyIdentifierRange: Range<Int64>?,
            sampleInfoRange: Range<Int64>?, sampleInfoByteLength: Int64?,
            constantIVRange: Range<Int64>?, constantIVByteLength: Int64?
        ) {
            self.version = version
            self.flags = flags
            self.sampleCount = sampleCount
    ...
    public struct SampleAuxInfoOffsetsBox: Equatable, Sendable {
        ...
        public init(
            version: UInt8, flags: UInt32, entryCount: UInt32, auxInfoType: FourCharCode?,
            auxInfoTypeParameter: UInt32?, entrySize: EntrySize, entriesRange: Range<Int64>?,
    ...
    public struct SampleAuxInfoSizesBox: Equatable, Sendable {
        ...
        public init(
            version: UInt8, flags: UInt32, defaultSampleInfoSize: UInt8, entryCount: UInt32,
            auxInfoType: FourCharCode?, auxInfoTypeParameter: UInt32?,
            variableEntriesRange: Range<Int64>?, variableEntriesByteLength: Int64?
        ) {
            self.version = version
            self.flags = flags
    ...
    public struct TrackFragmentBox: Equatable, Sendable {
        ...
        public init(
            trackID: UInt32?, sampleDescriptionIndex: UInt32?, baseDataOffset: UInt64?,
            defaultSampleDuration: UInt32?, defaultSampleSize: UInt32?, defaultSampleFlags: UInt32?,
            durationIsEmpty: Bool, defaultBaseIsMoof: Bool, baseDecodeTime: UInt64?,
            baseDecodeTimeIs64Bit: Bool, runs: [TrackRunBox], totalSampleCount: UInt64,
            totalSampleSize: UInt64?, totalSampleDuration: UInt64?,
            earliestPresentationTime: Int64?, latestPresentationTime: Int64?,
            firstDecodeTime: UInt64?, lastDecodeTime: UInt64?
        ) {
            self.trackID = trackID
            self.sampleDescriptionIndex = sampleDescriptionIndex
            self.baseDataOffset = baseDataOffset
    ...
    public struct TrackFragmentRandomAccessBox: Equatable, Sendable {
        public struct Entry: Equatable, Sendable {
            ...
            public init(
                index: UInt32, time: UInt64, moofOffset: UInt64, trafNumber: UInt64,
                trunNumber: UInt64, sampleNumber: UInt64, fragmentSequenceNumber: UInt32?,
                trackID: UInt32?, sampleDescriptionIndex: UInt32?, runIndex: UInt32?,
                firstSampleGlobalIndex: UInt64?, resolvedDecodeTime: UInt64?,
                resolvedPresentationTime: Int64?, resolvedDataOffset: UInt64?,
                resolvedSampleSize: UInt32?, resolvedSampleFlags: UInt32?
            ) {
                self.index = index
                self.time = time
        ...
        public init(
            version: UInt8, flags: UInt32, trackID: UInt32, trafNumberLength: UInt8,
            trunNumberLength: UInt8, sampleNumberLength: UInt8, entryCount: UInt32, entries: [Entry]
        ) {
            self.version = version
            self.flags = flags
            self.trackID = trackID
    ...
    public struct MovieFragmentRandomAccessOffsetBox: Equatable, Sendable {
        ...
        public init(mfraSize: UInt32) { self.mfraSize = mfraSize }
    }
    ...
    public struct MovieFragmentRandomAccessBox: Equatable, Sendable {
        public struct TrackSummary: Equatable, Sendable {
            ...
            public init(
                trackID: UInt32, entryCount: Int, earliestTime: UInt64?, latestTime: UInt64?,
        ...
        public init(
            tracks: [TrackSummary], totalEntryCount: Int,
    ...
    public struct VideoMediaHeaderBox: Equatable, Sendable {
        ...
        public init(
            version: UInt8, flags: UInt32, graphicsMode: UInt16, graphicsModeDescription: String?,
            opcolor: Opcolor
        ) {
            self.version = version
            self.flags = flags
    ...
    public struct EditListBox: Equatable, Sendable {
        public struct Entry: Equatable, Sendable {
            ...
            public init(
                index: UInt32, segmentDuration: UInt64, mediaTime: Int64, mediaRateInteger: Int16,
                mediaRateFraction: UInt16, mediaRate: Double, segmentDurationSeconds: Double?,
                mediaTimeSeconds: Double?, presentationStart: UInt64, presentationEnd: UInt64,
                presentationStartSeconds: Double?, presentationEndSeconds: Double?,
                isEmptyEdit: Bool
            ) {
                self.index = index
        ...
        public init(
            version: UInt8, flags: UInt32, entryCount: UInt32, movieTimescale: UInt32?,
            mediaTimescale: UInt32?, entries: [Entry]
        ) {
            self.version = version
            self.flags = flags
            self.entryCount = entryCount
    ...
    public struct SampleToChunkBox: Equatable, Sendable {
        public struct Entry: Equatable, Sendable {
            ...
            public init(
                firstChunk: UInt32, samplesPerChunk: UInt32, sampleDescriptionIndex: UInt32,
    ...
    public struct ChunkOffsetBox: Equatable, Sendable {
        ...
        public init(
            version: UInt8, flags: UInt32, entryCount: UInt32, width: Width, entries: [Entry]
        ) {
            self.version = version
            self.flags = flags
            self.entryCount = entryCount
    ...
    public struct DecodingTimeToSampleBox: Equatable, Sendable {
        public struct Entry: Equatable, Sendable {
            ...
            public init(
                index: UInt32, sampleCount: UInt32, sampleDelta: UInt32, byteRange: Range<Int64>
            ) {
                self.index = index
                self.sampleCount = sampleCount
    ...
    public struct CompositionOffsetBox: Equatable, Sendable {
        public struct Entry: Equatable, Sendable {
            ...
            public init(
                index: UInt32, sampleCount: UInt32, sampleOffset: Int32, byteRange: Range<Int64>
            ) {
                self.index = index
                self.sampleCount = sampleCount
    ...
    public struct SampleSizeBox: Equatable, Sendable {
        ...
        public init(
            version: UInt8, flags: UInt32, defaultSampleSize: UInt32, sampleCount: UInt32,
            entries: [Entry]
        ) {
            self.version = version
            self.flags = flags
    ...
    public struct CompactSampleSizeBox: Equatable, Sendable {
        ...
        public init(
            version: UInt8, flags: UInt32, fieldSize: UInt8, sampleCount: UInt32, entries: [Entry]
        ) {
            self.version = version
            self.flags = flags
    ...
    public struct DataReferenceBox: Equatable, Sendable {
        public struct Entry: Equatable, Sendable {
            ...
            public init(
                index: UInt32, type: FourCharCode, version: UInt8, flags: UInt32,
                location: Location, byteRange: Range<Int64>, payloadRange: Range<Int64>?
            ) {
                self.index = index
                self.type = type
                self.version = version
    ...
    public struct MetadataItemListBox: Equatable, Sendable {
        public struct Entry: Equatable, Sendable {
            ...
            public struct Value: Equatable, Sendable {
                public enum DataFormat: String, Equatable, Sendable {
                    ...
                    var displayName: String {
                        switch self {
                        case .jpeg: return "JPEG Data"
                        case .png: return "PNG Data"
                        case .bmp: return "BMP Data"
                        case .gif: return "GIF Data"
                        case .tiff: return "TIFF Data"
                        }
                    }
            ...
            public init(identifier: Identifier, namespace: String?, name: String?, values: [Value])
            {
    ...
    public struct Field: Equatable, Sendable {
        ...
        public init(
            name: String, value: String, description: String? = nil, byteRange: Range<Int64>? = nil
        ) {
            self.name = name
            self.value = value
