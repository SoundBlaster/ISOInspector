...
public enum FourCharContainerCode: String, CaseIterable, Codable, Hashable, Sendable {
    ...
    public static func isContainer(_ value: String) -> Bool { rawValueSet.contains(value) }
    ...
    public static func isContainer(_ header: BoxHeader) -> Bool { isContainer(header.type) }
}
