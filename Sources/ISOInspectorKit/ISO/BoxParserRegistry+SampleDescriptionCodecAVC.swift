...
extension BoxParserRegistry.DefaultParsers {
    static func parseAvcConfiguration(reader: RandomAccessReader, box: NestedBox, entryIndex: Int)
        -> [ParsedBoxPayload.Field]
    {
        ...
        fields.append(
            ParsedBoxPayload.Field(
                ...
                value: String(payload[0]), description: "AVC configuration version",
                byteRange: baseOffset..<(baseOffset + 1)))

        fields.append(
            ParsedBoxPayload.Field(
                name: "entries[\(entryIndex)].codec.avc.profile_indication",
                value: String(format: "0x%02X", payload[1]), description: "AVC profile indication",
        ...
        fields.append(
            ParsedBoxPayload.Field(
                ...
                value: String(payload[3]), description: "AVC level indication",
        ...
        fields.append(
            ParsedBoxPayload.Field(
                ...
                value: String(spsCount), description: "Number of SPS entries",
        ...
        for index in 0..<spsCount {
            ...
            fields.append(
                ParsedBoxPayload.Field(
                    name:
                        "entries[\(entryIndex)].codec.avc.sequence_parameter_sets[\(index)].length",
                    value: String(length), description: "Sequence parameter set length",
        ...
        fields.append(
            ParsedBoxPayload.Field(
                ...
                value: String(ppsCount), description: "Number of PPS entries",
        ...
        for index in 0..<ppsCount {
            ...
            fields.append(
                ParsedBoxPayload.Field(
                    name:
                        "entries[\(entryIndex)].codec.avc.picture_parameter_sets[\(index)].length",
                    value: String(length), description: "Picture parameter set length",
                    byteRange: lengthRange))
            offset += 2 + length
            if offset > payload.count { break }
        }
