...
public struct BoxParserRegistry: Sendable {
    ...
    private enum DefaultParsers {
        ...
        static func movieHeader(header: BoxHeader, reader: RandomAccessReader) throws -> ParsedBoxPayload? {
            ...
            let matrixEntries: [(name: String, description: String, fractionalBits: Int, precision: Int)] = [
                ("matrix.a", "Matrix element a (row 1 column 1)", 16, 4),
                ("matrix.b", "Matrix element b (row 1 column 2)", 16, 4),
                ("matrix.u", "Matrix element u (row 1 column 3)", 30, 6),
                ("matrix.c", "Matrix element c (row 2 column 1)", 16, 4),
                ("matrix.d", "Matrix element d (row 2 column 2)", 16, 4),
                ("matrix.v", "Matrix element v (row 2 column 3)", 30, 6),
                ("matrix.x", "Matrix element x (row 3 column 1)", 16, 4),
                ("matrix.y", "Matrix element y (row 3 column 2)", 16, 4),
                ("matrix.w", "Matrix element w (row 3 column 3)", 30, 6)
            ]
