...
extension FilesystemAccess {
    ...
    public static func live(
        ...
        securityScopeManager: any SecurityScopedAccessManaging =
            FoundationSecurityScopedAccessManager(), logger: FilesystemAccessLogger = .disabled,
        documentPickerPresenter: FilesystemDocumentPickerPresenter? = nil
            ...
            if let presenter = documentPickerPresenter {
                openHandler = { configuration in try await presenter.open(configuration) }
                saveHandler = { configuration in try await presenter.save(configuration) }
            } else {
        ...
        return FilesystemAccess(
            openFileHandler: openHandler, saveFileHandler: saveHandler,
            ...
            securityScopeManager: securityScopeManager, logger: logger)
    }
}
    ...
    extension FilesystemAccess {
        ...
        @MainActor fileprivate static func applyAllowedContentTypes(
        ...
        @available(macOS 11.0, *) fileprivate static func makeUniformTypes(
