...
public extension ValidationRuleIdentifier {
    var displayName: String {
        switch self {
        case .structuralSize:
            return "Box Size Integrity"
        case .containerBoundary:
            return "Container Boundary Closure"
        case .versionFlags:
            return "Version and Flags Consistency"
        case .fileTypeOrdering:
            return "File Type Ordering"
        case .movieDataOrdering:
            return "Movie Data Ordering"
        case .researchLogRecording:
            return "Research Log Recording"
        case .editListDuration:
            return "Edit List Duration Reconciliation"
        case .sampleTableCorrelation:
            return "Sample Table Correlation"
        case .fragmentSequence:
            return "Fragment Sequence Order"
        case .fragmentRun:
            return "Fragment Run Integrity"
        case .codecConfiguration:
            return "Codec Configuration Integrity"
        }
    }
    ...
    var summary: String {
        ...
        case .fileTypeOrdering:
            return "Requires the ftyp box to appear before any media container."
        case .movieDataOrdering:
        ...
        case .fragmentSequence:
            return "Flags non-monotonic fragment identifiers or unexpected gaps in sequence numbers."
        case .fragmentRun:
    ...
    var defaultSeverity: ValidationIssue.Severity {
        switch self {
        case .structuralSize, .containerBoundary, .fileTypeOrdering, .sampleTableCorrelation, .fragmentRun, .codecConfiguration:
            return .error
