...
public enum ResearchLogSchema {
    ...
    public static let fieldNames = ["boxType", "filePath", "startOffset", "endOffset"]
}
...
public enum ResearchLogMonitor {
    ...
    public static func audit(logURL: URL, fileManager: FileManager = .default) throws
        -> ResearchLogAudit
    {
        ...
        return ResearchLogAudit(
            schemaVersion: ResearchLogSchema.version, fieldNames: ResearchLogSchema.fieldNames,
            entryCount: entries.count, logExists: true)
    }
}
