...
extension ParseTreeBuilder {
    ...
    fileprivate func issueFrom(_ requirement: ParseTree.PlaceholderPlanner.Requirement, _ node: ParseTreeBuilder.MutableNode, _ placeholderHeader: BoxHeader) -> ParseIssue {
