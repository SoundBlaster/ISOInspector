        ...
        InspectorPattern(title: "Box Inspector") {
            VStack(spacing: 0) {
                ...
                VStack(spacing: DS.Spacing.m) {
                    Text("Select background material:")
                ...
                VStack(spacing: DS.Spacing.m) {
                    ...
                    HStack {
                        ...
                        Badge(
                            ...
                            level: sampleBox.status.badgeLevel,
                            showIcon: false
                        )
                    }
                    ...
                    KeyValueRow(
                        key: "Description",
                        value: sampleBox.typeDescription
                    )
                ...
                VStack(alignment: .leading, spacing: DS.Spacing.m) {
                    Label {
                        Text("Click copy icon to copy hex values")
                            .font(DS.Typography.caption)
                    } icon: {
                    ...
                    Label {
                        Text("Material affects background translucency")
                            .font(DS.Typography.caption)
                    } icon: {
                    ...
                    Label {
                        Text("Toggle Dark Mode to see material effects")
                            .font(DS.Typography.caption)
                    } icon: {
