    ...
    final class SurfaceStyleKeyTests: XCTestCase {
        ...
        func testDefaultValue() throws {
            ...
            XCTAssertEqual(
                SurfaceStyleKey.defaultValue, .regular, "Default surface style should be .regular")
        }
        ...
        func testCustomEnvironmentValue() throws {
            ...
            struct ParentView: View {
                var body: some View { ChildView().environment(\.surfaceStyle, .thin) }
            }
        ...
        func testAllMaterialTypes() throws {
            ...
            for material in materials {
                ...
                XCTAssertFalse(
                    material.description.isEmpty, "Material \(material) should have a description")
        ...
        func testEnvironmentPropagation() throws {
            struct GrandparentView: View {
                var body: some View { ParentView().environment(\.surfaceStyle, .thick) }
            }
            ...
            struct ChildView: View {
                ...
                var body: some View { Text("Grandchild") }
            }
            ...
            struct ParentView: View {
                var body: some View {
                    VStack {
                        ...
                        // Overrides to .thin
                        ChildView(name: "Child 2").environment(\.surfaceStyle, .thin)
        ...
        func testIntegrationWithModifier() throws {
            struct TestView: View {
                ...
                var body: some View {
                    VStack { Text("Content") }.surfaceStyle(material: surfaceStyle)
                }
            }
        ...
        func testEquatableConformance() throws {
            ...
            XCTAssertEqual(
                defaultValue, regularMaterial, "Default value should equal .regular material")
        }
    }
            ...
            struct InspectorView: View {
                var body: some View {
                    HStack(spacing: 0) {
                        ...
                        VStack { Text("Inspector") }.frame(width: 250).environment(
                            \.surfaceStyle, .thick)
                    }
                }
            }
                ...
                var body: some View {
                    ZStack {
                        ...
                        if showModal {
                            ...
                            Text("Modal").padding().environment(\.surfaceStyle, .ultra)
                        }
                    }
                }
            }
            ...
            struct SidebarView: View {
                var body: some View {
                    NavigationSplitView {
                        ...
                        Text("Detail").environment(\.surfaceStyle, .regular)
                    }
                }
            }
