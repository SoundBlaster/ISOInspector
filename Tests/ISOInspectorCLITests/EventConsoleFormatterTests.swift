...
final class EventConsoleFormatterTests: XCTestCase {
    ...
    func testFormatterIncludesValidationIssues() throws {
        ...
        let issue = ValidationIssue(
            ruleID: "VR-003", message: "Expected version 0 but found 1", severity: .warning)
        let event = ParseEvent(
            kind: .willStartBox(header: header, depth: 1), offset: 8, metadata: descriptor,
        ...
        let payload = ParsedBoxPayload(
            fields: [
                ParsedBoxPayload.Field(
                    name: "version", value: "0", description: "Structure version", byteRange: 8..<9),
                ParsedBoxPayload.Field(
                    name: "flags", value: "0x000000", description: "Bit flags", byteRange: 9..<12),
                ParsedBoxPayload.Field(
                    name: "sequence_number", value: "7", description: "Fragment sequence number",
                    byteRange: 12..<16),
            ],
            detail: .movieFragmentHeader(
                ParsedBoxPayload.MovieFragmentHeaderBox(version: 0, flags: 0, sequenceNumber: 7)))
        let event = ParseEvent(
            kind: .willStartBox(header: header, depth: 0), offset: 0, payload: payload)
    ...
    func testFormatterIncludesTrackFragmentHeaderTrackID() throws {
        ...
        let payload = ParsedBoxPayload(
            fields: [
                ParsedBoxPayload.Field(
                    name: "track_id", value: "42", description: "Track identifier",
                    byteRange: 12..<16)
            ],
            detail: .trackFragmentHeader(
                ParsedBoxPayload.TrackFragmentHeaderBox(
                    version: 0, flags: 0, trackID: 42, baseDataOffset: nil,
                    sampleDescriptionIndex: nil, defaultSampleDuration: nil, defaultSampleSize: nil,
                    defaultSampleFlags: nil, durationIsEmpty: false, defaultBaseIsMoof: false)))
        let event = ParseEvent(
            kind: .willStartBox(header: header, depth: 0), offset: 0, payload: payload)
        ...
        let payload = ParsedBoxPayload(
            detail: .trackFragmentDecodeTime(
                ParsedBoxPayload.TrackFragmentDecodeTimeBox(
                    version: 1, flags: 0, baseMediaDecodeTime: 9000,
    ...
    func testFormatterIncludesTrackRunSummary() throws {
        ...
        let run = ParsedBoxPayload.TrackRunBox(
            version: 0, flags: 0x000001, sampleCount: 3, dataOffset: 256, firstSampleFlags: nil,
            entries: [], totalSampleDuration: 180, totalSampleSize: 1500, startDecodeTime: 1000,
            endDecodeTime: 1180, startPresentationTime: 1000, endPresentationTime: 1180,
            startDataOffset: 2048, endDataOffset: 2048 + 1500, trackID: 7,
            sampleDescriptionIndex: 2, runIndex: 0, firstSampleGlobalIndex: 1)
    ...
    func testFormatterSummarizesMovieFragmentRandomAccess() throws {
        ...
        let box = ParsedBoxPayload.MovieFragmentRandomAccessBox(
            tracks: [trackSummary], totalEntryCount: 1,
        ...
        let event = ParseEvent(
            kind: .didFinishBox(header: header, depth: 0), offset: 0, payload: payload)
    ...
    func testFormatterHighlightsRunWithNegativeDataOffset() throws {
        let header = try makeHeader(type: "trun", size: 24)
        let run = ParsedBoxPayload.TrackRunBox(
            version: 0, flags: 0x000200, sampleCount: 1, dataOffset: -64, firstSampleFlags: nil,
            entries: [], totalSampleDuration: 240, totalSampleSize: 480, startDecodeTime: nil,
            endDecodeTime: nil, startPresentationTime: nil, endPresentationTime: nil,
            startDataOffset: nil, endDataOffset: nil, trackID: 2, sampleDescriptionIndex: 1,
            runIndex: 1, firstSampleGlobalIndex: 5)
        let payload = ParsedBoxPayload(detail: .trackRun(run))
        let event = ParseEvent(
            kind: .willStartBox(header: header, depth: 0), offset: 0, payload: payload)
    ...
    func testFormatterIncludesTrackFragmentSummary() throws {
        ...
        let fragment = ParsedBoxPayload.TrackFragmentBox(
            trackID: 9, sampleDescriptionIndex: 5, baseDataOffset: 4096, defaultSampleDuration: 100,
            defaultSampleSize: 512, defaultSampleFlags: 0x0102_0304, durationIsEmpty: false,
            defaultBaseIsMoof: true, baseDecodeTime: 1200, baseDecodeTimeIs64Bit: false, runs: [],
            totalSampleCount: 4, totalSampleSize: 2048, totalSampleDuration: 400,
            earliestPresentationTime: 1000, latestPresentationTime: 1600, firstDecodeTime: 1200,
            lastDecodeTime: 1600)
    ...
    func testFormatterSummarizesSampleAuxInfoOffsets() throws {
        ...
        let detail = ParsedBoxPayload.SampleAuxInfoOffsetsBox(
            ...
            auxInfoTypeParameter: 2, entrySize: .eightBytes, entriesRange: 80..<104,
    ...
    func testFormatterSummarizesSampleAuxInfoSizes() throws {
        ...
        let detail = ParsedBoxPayload.SampleAuxInfoSizesBox(
            ...
            auxInfoType: try FourCharCode("cenc"), auxInfoTypeParameter: 2,
