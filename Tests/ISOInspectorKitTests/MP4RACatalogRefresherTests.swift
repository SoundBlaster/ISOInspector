...
final class MP4RACatalogRefresherTests: XCTestCase {
  ...
  func testMakeCatalogMergesBaselineEntries() throws {
    ...
    XCTAssertEqual(
      ftypEntry.summary, "Identifies the file type and compatibility brands for the bitstream.")
    ...
    XCTAssertEqual(
      uuidEntry.summary, "Carries SMPTE KLV sample metadata using a registered UUID container.")
