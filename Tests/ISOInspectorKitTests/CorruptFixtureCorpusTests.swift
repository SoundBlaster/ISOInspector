...
final class CorruptFixtureCorpusTests: XCTestCase {
    ...
    private lazy var manifestURL: URL = {
        let root = URL(fileURLWithPath: #filePath).deletingLastPathComponent()  // CorruptFixtureCorpusTests.swift
    ...
    func testManifestDefinesCorruptionScenarios() throws {
        ...
        for fixture in manifest.fixtures {
            ...
            XCTAssertTrue(
                identifiers.insert(fixture.id).inserted, "Duplicate fixture id \(fixture.id)")
            ...
            XCTAssertFalse(
                fixture.corruption.expectedIssues.isEmpty,
                "Fixture \(fixture.id) missing expected issues")
