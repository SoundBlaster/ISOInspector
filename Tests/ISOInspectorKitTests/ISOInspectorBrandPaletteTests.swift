...
final class ISOInspectorBrandPaletteTests: XCTestCase {
  func testLightModeAccentContrast() {
    ...
    XCTAssertGreaterThanOrEqual(
      contrast, 4.5, "Light mode accent should meet WCAG AA contrast against light background")
  }
  ...
  func testDarkModeAccentContrast() {
    ...
    XCTAssertGreaterThanOrEqual(
      contrast, 4.5, "Dark mode accent should meet WCAG AA contrast against dark background")
  }
}
