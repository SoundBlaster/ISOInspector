...
final class TfhdTrackFragmentHeaderParserTests: XCTestCase {
    func testParsesTrackFragmentHeaderDefaults() throws {
        ...
        let payload = makeTfhdPayload(
            flags: flags, trackID: 0x0102_0304, baseDataOffset: 0x0102_0304_0506_0708,
            sampleDescriptionIndex: 0x0102_0304, defaultSampleDuration: 0x0203_0405,
            defaultSampleSize: 0x0304_0506, defaultSampleFlags: 0x0405_0607)
    ...
    private func parseTfhd(payload: Data) throws -> ParsedBoxPayload? {
        ...
        let header = BoxHeader(
            type: try FourCharCode("tfhd"), totalSize: Int64(totalSize), headerSize: 8,
    ...
    private func makeTfhdPayload(
        flags: UInt32, trackID: UInt32, baseDataOffset: UInt64, sampleDescriptionIndex: UInt32,
        ...
        if flags & 0x000001 != 0 { payload.append(contentsOf: baseDataOffset.bigEndianBytes) }
        if flags & 0x000002 != 0 {
        ...
        if flags & 0x000010 != 0 { payload.append(contentsOf: defaultSampleSize.bigEndianBytes) }
        if flags & 0x000020 != 0 { payload.append(contentsOf: defaultSampleFlags.bigEndianBytes) }
        return payload
    }
}
