...
struct FixtureCatalog: Decodable {
    struct Fixture: Decodable, Equatable {
        struct Resource: Decodable, Equatable {
            ...
            func url(in bundle: Bundle) throws -> URL {
                guard
                    ...
                    throw FixtureCatalogError.missingResource(
                        name: name, extension: `extension`, subdirectory: subdirectory)
                }
                return url
            }
        }
        ...
        struct Provenance: Decodable, Equatable { let source: String }
        ...
        func url(in bundle: Bundle) throws -> URL {
            if let url = try? resource.url(in: bundle) { return url }
            ...
            throw FixtureCatalogError.missingResource(
                name: resource.name, extension: resource.extension,
        ...
        func data(in bundle: Bundle) throws -> Data {
            ...
            if url.pathExtension == "txt" {
                ...
                else { throw FixtureCatalogError.invalidEncoding(name: resource.name) }
                return decoded
            }
    ...
    static func load(decoder: JSONDecoder = JSONDecoder(), bundle: Bundle = .module) throws
        -> FixtureCatalog
    {
    ...
    func fixture(withID id: String) -> Fixture? { fixtures.first { $0.id == id } }
}
