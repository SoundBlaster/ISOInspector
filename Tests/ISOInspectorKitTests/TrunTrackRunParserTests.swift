...
final class TrunTrackRunParserTests: XCTestCase {
    func testParsesTrackRunWithAllFields() throws {
        ...
        let environment = BoxParserRegistry.FragmentEnvironment(
            trackID: 1, sampleDescriptionIndex: 7, defaultSampleDuration: 90,
            defaultSampleSize: 800, defaultSampleFlags: 0x0102_0304, baseDataOffset: 5000,
            dataCursor: nil, nextDecodeTime: 9000, baseDecodeTime: 9000,
            baseDecodeTimeIs64Bit: false, trackExtendsDefaults: nil, trackFragmentHeader: nil,
            trackFragmentDecodeTime: nil, runIndex: 0, nextSampleNumber: 1)
    ...
    func testParsesTrackRunUsingDefaultsWhenOptionalFieldsMissing() throws {
        ...
        payload.append(contentsOf: UInt32(0xFFFF_FFFF).bigEndianBytes)  // first_sample_flags

        let environment = BoxParserRegistry.FragmentEnvironment(
            trackID: 2, sampleDescriptionIndex: 9, defaultSampleDuration: 200,
            defaultSampleSize: 1500, defaultSampleFlags: 0x0102_0304, baseDataOffset: 8000,
            dataCursor: nil, nextDecodeTime: 5000, baseDecodeTime: 5000,
            baseDecodeTimeIs64Bit: false, trackExtendsDefaults: nil,
            trackFragmentHeader: ParsedBoxPayload.TrackFragmentHeaderBox(
                version: 0, flags: 0, trackID: 2, baseDataOffset: nil, sampleDescriptionIndex: nil,
                defaultSampleDuration: nil, defaultSampleSize: nil, defaultSampleFlags: nil,
                durationIsEmpty: false, defaultBaseIsMoof: true),
            trackFragmentDecodeTime: ParsedBoxPayload.TrackFragmentDecodeTimeBox(
                version: 0, flags: 0, baseMediaDecodeTime: 5000, baseMediaDecodeTimeIs64Bit: false),
            runIndex: 0, nextSampleNumber: 1)
    ...
    private func parseTrun(payload: Data, environment: BoxParserRegistry.FragmentEnvironment) throws
        -> ParsedBoxPayload?
    {
        ...
        let header = BoxHeader(
            type: try FourCharCode("trun"), totalSize: Int64(totalSize), headerSize: 8,
