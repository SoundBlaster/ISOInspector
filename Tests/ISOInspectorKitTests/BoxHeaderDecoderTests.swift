...
final class BoxHeaderDecoderTests: XCTestCase {
    ...
    func testZeroSizedBoxExpandsToParentRangeEnd() throws {
        ...
        let result = BoxHeaderDecoder.readHeader(from: reader, at: 0, inParentRange: 0..<Int64(32))
    ...
    func testHeaderExtendingBeyondParentThrows() throws {
        ...
        guard case BoxHeaderDecodingError.exceedsParent(let expectedEnd, let parentEnd) = error
        else {
            XCTFail("Unexpected error: \(error)")
            return
        }
