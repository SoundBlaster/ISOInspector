...
final class DocumentRecentsStoreTests: XCTestCase {
    ...
    func testSavedRecentsArePersisted() throws {
        ...
        let entries = [
            DocumentRecent(
                url: fileURL, bookmarkIdentifier: bookmarkID, bookmarkData: Data("bookmark".utf8),
                displayName: "Example", lastOpened: Date(timeIntervalSince1970: 12345)),
            DocumentRecent(
                url: fileURL.appendingPathComponent("other"), bookmarkData: nil,
                displayName: "Other", lastOpened: Date(timeIntervalSince1970: 67890)),
        ]
