...
final class WorkspaceSessionStoreTests: XCTestCase {
    ...
    private func makeSampleSnapshot() -> WorkspaceSessionSnapshot {
        ...
        let primaryRecent = DocumentRecent(
            url: primaryURL, bookmarkData: Data([0x01]), displayName: "Sample",
            lastOpened: Date(timeIntervalSince1970: 100))
        let secondaryRecent = DocumentRecent(
            url: secondaryURL, bookmarkData: nil, displayName: "Second",
        ...
        return WorkspaceSessionSnapshot(
            ...
            files: [
                WorkspaceSessionFileSnapshot(
                    ...
                    recent: primaryRecent, orderIndex: 0, lastSelectionNodeID: 42, isPinned: false,
                    ...
                    bookmarkDiffs: [
                        WorkspaceSessionBookmarkDiff(
                            ...
                            bookmarkID: primaryRecent.bookmarkIdentifier, isRemoved: false,
                            noteDelta: "initial")
                    ], validationConfiguration: nil),
                WorkspaceSessionFileSnapshot(
                    id: UUID(uuidString: "00000000-0000-0000-0000-0000000000CC")!,
                    recent: secondaryRecent, orderIndex: 1, lastSelectionNodeID: nil,
                    isPinned: true, scrollOffset: nil,
                    bookmarkIdentifier: secondaryRecent.bookmarkIdentifier, bookmarkDiffs: [],
                    validationConfiguration: nil),
            ], focusedFileURL: primaryURL, lastSceneIdentifier: "scene",
            windowLayouts: [
                WorkspaceWindowLayoutSnapshot(
                    id: UUID(uuidString: "00000000-0000-0000-0000-0000000000DD")!,
                    sceneIdentifier: "scene", serializedLayout: Data([0xAA, 0xBB]),
