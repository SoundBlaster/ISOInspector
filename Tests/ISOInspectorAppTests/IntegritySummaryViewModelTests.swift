    ...
    @MainActor final class IntegritySummaryViewModelTests: XCTestCase {
        ...
        func testOffsetSorting_PrimarySortByByteOffset() async {
            ...
            store.issueStore.record(
                ParseIssue(
                    severity: .error, code: "ERR-003", message: "Error at offset 300",
                    byteRange: 300..<400, affectedNodeIDs: [3]), depth: 1)
            store.issueStore.record(
                ParseIssue(
                    severity: .error, code: "ERR-001", message: "Error at offset 100",
                    byteRange: 100..<200, affectedNodeIDs: [1]), depth: 1)
            store.issueStore.record(
                ParseIssue(
                    severity: .error, code: "ERR-002", message: "Error at offset 200",
                    byteRange: 200..<300, affectedNodeIDs: [2]), depth: 1)
        ...
        func testOffsetSorting_SecondaryTieBreakerBySeverity() async {
            ...
            store.issueStore.record(
                ParseIssue(
                    severity: .info, code: "INFO-001", message: "Info at offset 100",
                    byteRange: 100..<200, affectedNodeIDs: [1]), depth: 1)
            store.issueStore.record(
                ParseIssue(
                    severity: .error, code: "ERR-001", message: "Error at offset 100",
                    byteRange: 100..<200, affectedNodeIDs: [2]), depth: 1)
            store.issueStore.record(
                ParseIssue(
                    severity: .warning, code: "WARN-001", message: "Warning at offset 100",
                    byteRange: 100..<200, affectedNodeIDs: [3]), depth: 1)
        ...
        func testOffsetSorting_TertiaryTieBreakerByCode() async {
            ...
            store.issueStore.record(
                ParseIssue(
                    severity: .error, code: "ERR-003", message: "Error C at offset 100",
                    byteRange: 100..<200, affectedNodeIDs: [3]), depth: 1)
            store.issueStore.record(
                ParseIssue(
                    severity: .error, code: "ERR-001", message: "Error A at offset 100",
                    byteRange: 100..<200, affectedNodeIDs: [1]), depth: 1)
            store.issueStore.record(
                ParseIssue(
                    severity: .error, code: "ERR-002", message: "Error B at offset 100",
                    byteRange: 100..<200, affectedNodeIDs: [2]), depth: 1)
        ...
        func testOffsetSorting_IssuesWithoutByteRangeSortToEnd() async {
            ...
            store.issueStore.record(
                ParseIssue(
                    severity: .error, code: "ERR-002", message: "Error with offset",
                    byteRange: 100..<200, affectedNodeIDs: [2]), depth: 1)
            store.issueStore.record(
                ParseIssue(
                    severity: .error, code: "ERR-001", message: "Error without offset",
                    byteRange: nil, affectedNodeIDs: [1]), depth: 1)
            store.issueStore.record(
                ParseIssue(
                    severity: .error, code: "ERR-003", message: "Another error with offset",
                    byteRange: 300..<400, affectedNodeIDs: [3]), depth: 1)
        ...
        func testAffectedNodeSorting_PrimarySortByFirstNodeID() async {
            ...
            store.issueStore.record(
                ParseIssue(
                    severity: .error, code: "ERR-003", message: "Error affecting node 30",
                    byteRange: 300..<400, affectedNodeIDs: [30]), depth: 1)
            store.issueStore.record(
                ParseIssue(
                    severity: .error, code: "ERR-001", message: "Error affecting node 10",
                    byteRange: 100..<200, affectedNodeIDs: [10]), depth: 1)
            store.issueStore.record(
                ParseIssue(
                    severity: .error, code: "ERR-002", message: "Error affecting node 20",
                    byteRange: 200..<300, affectedNodeIDs: [20]), depth: 1)
        ...
        func testAffectedNodeSorting_SecondaryTieBreakerBySeverity() async {
            ...
            store.issueStore.record(
                ParseIssue(
                    severity: .info, code: "INFO-001", message: "Info affecting node 10",
                    byteRange: 100..<200, affectedNodeIDs: [10]), depth: 1)
            store.issueStore.record(
                ParseIssue(
                    severity: .error, code: "ERR-001", message: "Error affecting node 10",
                    byteRange: 300..<400, affectedNodeIDs: [10]), depth: 1)
            store.issueStore.record(
                ParseIssue(
                    severity: .warning, code: "WARN-001", message: "Warning affecting node 10",
                    byteRange: 200..<300, affectedNodeIDs: [10]), depth: 1)
        ...
        func testAffectedNodeSorting_TertiaryTieBreakerByOffset() async {
            ...
            XCTAssertEqual(
                sortedIssues[1].byteRange?.lowerBound, 200, "Offset 200 should be second")
        ...
        func testAffectedNodeSorting_IssuesWithEmptyNodesSortToEnd() async {
            ...
            store.issueStore.record(
                ParseIssue(
                    severity: .error, code: "ERR-002", message: "Error with node",
                    byteRange: 100..<200, affectedNodeIDs: [10]), depth: 1)
            store.issueStore.record(
                ParseIssue(
                    severity: .error, code: "ERR-001", message: "Error without node",
                    byteRange: 300..<400, affectedNodeIDs: []), depth: 1)
            store.issueStore.record(
                ParseIssue(
                    severity: .error, code: "ERR-003", message: "Another error with node",
                    byteRange: 200..<300, affectedNodeIDs: [20]), depth: 1)
            ...
            XCTAssertEqual(sortedIssues[1].affectedNodeIDs.first, 20)
            XCTAssertTrue(
                sortedIssues[2].affectedNodeIDs.isEmpty,
                "Issue without affected nodes should be last")
        }
        ...
        func testSeveritySorting_RemainsDeterministic() async {
            ...
            store.issueStore.record(
                ParseIssue(
                    severity: .error, code: "ERR-003", message: "Error C", byteRange: 300..<400,
                    affectedNodeIDs: [3]), depth: 1)
            store.issueStore.record(
                ParseIssue(
                    severity: .error, code: "ERR-001", message: "Error A", byteRange: 100..<200,
                    affectedNodeIDs: [1]), depth: 1)
            store.issueStore.record(
                ParseIssue(
                    severity: .warning, code: "WARN-001", message: "Warning", byteRange: 200..<300,
                    affectedNodeIDs: [2]), depth: 1)
