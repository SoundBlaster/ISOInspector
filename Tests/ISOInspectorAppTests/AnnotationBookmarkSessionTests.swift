    ...
    @MainActor final class AnnotationBookmarkSessionTests: XCTestCase {
        ...
        @unchecked Sendable
    {
        ...
        func createAnnotation(for file: URL, nodeID: Int64, note: String) throws -> AnnotationRecord
        {
            ...
            let record = AnnotationRecord(
                id: UUID(), nodeID: nodeID, note: note, createdAt: currentDate,
        ...
        func setBookmark(for file: URL, nodeID: Int64, isBookmarked: Bool) throws {
            ...
            if isBookmarked { set.insert(nodeID) } else { set.remove(nodeID) }
