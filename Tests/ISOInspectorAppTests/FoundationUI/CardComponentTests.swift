    ...
    final class CardComponentTests: XCTestCase {
        ...
        func testCardInitializationWithDefaults() {
            let card = Card { Text("Test Content") }
        ...
        func testCardInitializationWithCustomElevation() {
            let card = Card(elevation: .high) { Text("Test Content") }
        ...
        func testCardInitializationWithCustomCornerRadius() {
            let card = Card(cornerRadius: DS.Radius.small) { Text("Test Content") }
        ...
        func testCardInitializationWithMaterial() {
            let card = Card(material: .regular) { Text("Test Content") }
        ...
        func testCardInitializationWithAllParameters() {
            let card = Card(elevation: .low, cornerRadius: DS.Radius.medium, material: .thin) {
                Text("Test Content")
            }
        ...
        func testCardWithNoElevation() {
            let card = Card(elevation: .none) { Text("No Elevation") }
        ...
        func testCardWithLowElevation() {
            let card = Card(elevation: .low) { Text("Low Elevation") }
        ...
        func testCardWithMediumElevation() {
            let card = Card(elevation: .medium) { Text("Medium Elevation") }
        ...
        func testCardWithHighElevation() {
            let card = Card(elevation: .high) { Text("High Elevation") }
        ...
        func testCardWithSmallCornerRadius() {
            let card = Card(cornerRadius: DS.Radius.small) { Text("Small Radius") }
        ...
        func testCardWithMediumCornerRadius() {
            let card = Card(cornerRadius: DS.Radius.medium) { Text("Medium Radius") }
        ...
        func testCardWithCardCornerRadius() {
            let card = Card(cornerRadius: DS.Radius.card) { Text("Card Radius") }
        ...
        func testCardWithoutMaterial() {
            let card = Card { Text("No Material") }
        ...
        func testCardWithUltraThinMaterial() {
            let card = Card(material: .ultraThin) { Text("Ultra Thin Material") }
        ...
        func testCardWithThinMaterial() {
            let card = Card(material: .thin) { Text("Thin Material") }
        ...
        func testCardWithRegularMaterial() {
            let card = Card(material: .regular) { Text("Regular Material") }
        ...
        func testCardWithThickMaterial() {
            let card = Card(material: .thick) { Text("Thick Material") }
        ...
        func testCardBodyRendersForAllMaterials() {
            ...
            for material in materials {
                let card = Card(material: material) { Text("Test") }
        ...
        func testCardWithSimpleTextContent() {
            let card = Card { Text("Simple Text") }
        ...
        func testCardPlatformCompatibility() {
            #if os(iOS)
                let card = Card { Text("iOS Card") }
                XCTAssertNotNil(card.body, "Card should work on iOS")
            #elseif os(macOS)
                let card = Card { Text("macOS Card") }
        ...
        @available(iOS 17.0, macOS 14.0, *) @MainActor func testCardAgentDescribableComponentType()
        {
            let card = Card { Text("Test") }
        ...
        @available(iOS 17.0, macOS 14.0, *) @MainActor func testCardAgentDescribableProperties() {
            let card = Card(elevation: .high, cornerRadius: DS.Radius.card) { Text("Test") }
        ...
        func testCardAgentDescribablePropertiesWithMaterial() {
            let card = Card(elevation: .medium, material: .regular) { Text("Test") }
            let properties = card.properties
        ...
        @available(iOS 17.0, macOS 14.0, *) @MainActor func testCardAgentDescribableSemantics() {
            let card = Card(elevation: .high, cornerRadius: 10) { Text("Test") }
        ...
        func testNestedCards() {
            let outerCard = Card(elevation: .high) {
                VStack {
                    Text("Outer Card")
                    Card(elevation: .low) { Text("Inner Card") }
                }
            }
        ...
        func testNestedCardsWithDifferentElevations() {
            let card = Card(elevation: .high) {
                VStack {
                    Card(elevation: .medium) { Text("Medium") }
                    Card(elevation: .low) { Text("Low") }
                }
            }
        ...
        func testCardWithZeroCornerRadius() {
            let card = Card(cornerRadius: 0) { Text("No Rounding") }
        ...
        func testCardWithLargeCornerRadius() {
            let card = Card(cornerRadius: 50) { Text("Very Rounded") }
        ...
        func testCardWithMaterialAndElevation() {
            let card = Card(elevation: .high, material: .regular) { Text("Material + Elevation") }
