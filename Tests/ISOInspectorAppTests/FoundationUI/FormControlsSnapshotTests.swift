    ...
    final class FormControlsSnapshotTests: XCTestCase {
        ...
        @MainActor func testBoxToggleView_LightMode_Enabled() {
            let toggle = BoxToggleView(isOn: .constant(true), label: "Enable strict validation")
        ...
        @MainActor func testBoxToggleView_DarkMode_Enabled() {
            let toggle = BoxToggleView(isOn: .constant(true), label: "Enable strict validation")
        ...
        @MainActor func testBoxToggleView_DisabledState() {
            let toggle = BoxToggleView(
                isOn: .constant(false), label: "Disabled toggle", disabled: true)
        ...
        @MainActor func testBoxTextInputView_EmptyState() {
            let input = BoxTextInputView(text: .constant(""), placeholder: "Enter box name...")
        ...
        @MainActor func testBoxTextInputView_FilledState() {
            let input = BoxTextInputView(text: .constant("ftyp"), placeholder: "Enter box name...")
        ...
        @MainActor func testBoxTextInputView_ErrorState() {
            let input = BoxTextInputView(
                text: .constant("invalid"), placeholder: "Enter box name...",
        ...
        @MainActor func testBoxTextInputView_LightMode() {
            let input = BoxTextInputView(text: .constant("test"), placeholder: "Placeholder")
                .environment(\.colorScheme, .light)
        ...
        @MainActor func testBoxTextInputView_DarkMode() {
            let input = BoxTextInputView(text: .constant("test"), placeholder: "Placeholder")
                .environment(\.colorScheme, .dark)
        ...
        @MainActor func testBoxPickerView_SegmentedStyle() {
        ...
        @MainActor func testBoxPickerView_MenuStyle() {
            let picker = BoxPickerView(
        ...
        @MainActor func testBoxPickerView_LightMode() {
            let picker = BoxPickerView(
                selection: .constant("a"), label: "Option",
        ...
        @MainActor func testBoxPickerView_DarkMode() {
            let picker = BoxPickerView(
                selection: .constant("a"), label: "Option",
                options: [(label: "A", value: "a"), (label: "B", value: "b")]
            ).environment(\.colorScheme, .dark)
        ...
        // MARK: - Platform-Specific Snapshots
            ...
            @MainActor func testFormControls_macOSRendering() {
                ...
                let picker = BoxPickerView(
                    selection: .constant(1), label: "macOS Picker",
            ...
            @MainActor func testFormControls_iOSRendering() {
                ...
                let picker = BoxPickerView(
                    selection: .constant(1), label: "iOS Picker",
                    options: [(label: "One", value: 1), (label: "Two", value: 2)])
