...
final class FormControlsAccessibilityTests: XCTestCase {
    ...
    func testBoxTextInputView_VoiceOverAnnouncements() {
        ...
        XCTAssertTrue(type(of: emptyInput) == BoxTextInputView.self,
                     "Empty input should announce placeholder")
        XCTAssertTrue(type(of: filledInput) == BoxTextInputView.self,
    ...
    func testBoxToggleView_DynamicTypeScaling() {
        ...
        for category in sizeCategories {
            ...
            XCTAssertTrue(type(of: toggle) == BoxToggleView.self,
                         "Toggle should scale for size category: \(category)")
        }
    }
    ...
    func testBoxTextInputView_DynamicTypeScaling() {
        ...
        for category in testCategories {
            ...
            XCTAssertTrue(type(of: input) == BoxTextInputView.self,
                         "Input should scale for size category: \(category)")
        }
    }
    ...
    func testBoxPickerView_DynamicTypeScaling() {
        ...
        for category in testCategories {
            ...
            XCTAssertTrue(type(of: picker) == BoxPickerView<Int>.self,
                         "Picker should scale for size category: \(category)")
        }
    }
