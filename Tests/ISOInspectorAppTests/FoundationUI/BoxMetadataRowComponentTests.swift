...
final class BoxMetadataRowComponentTests: XCTestCase {
    ...
    func testBoxMetadataRowVerticalLayout() {
        let row = BoxMetadataRow(
            label: "Description",
            value: "A very long description that benefits from vertical layout",
            layout: .vertical
        )
    ...
    func testBoxMetadataRowCopyableWithVerticalLayout() {
        let row = BoxMetadataRow(
            label: "Description",
            value: "Long value for vertical layout",
            layout: .vertical,
            copyable: true
        )
    ...
    func testBoxMetadataRowVerticalLayoutSpacing() {
        let row = BoxMetadataRow(
            label: "Description",
            value: "Long value that needs vertical layout for readability",
            layout: .vertical
        )
