  ...
  final class ParseTreeAccessibilityFormatterTests: XCTestCase {
    func testOutlineRowDescriptorIncludesTypeSeverityAndBookmarkState() throws {
      ...
      let node = ParseTreeNode(
        ...
        payload: nil,
        validationIssues: [
          ValidationIssue(ruleID: "VR-002", message: "Track missing language", severity: .warning)
        ],
        children: [
          ParseTreeNode(
            header: BoxHeader(
      ...
      XCTAssertEqual(
        descriptor.hint, "Press Return to expand or collapse. Press Space to toggle bookmark.")
    }
