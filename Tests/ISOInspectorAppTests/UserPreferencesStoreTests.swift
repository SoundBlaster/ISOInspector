    ...
    @MainActor final class UserPreferencesStoreTests: XCTestCase {
        ...
        func testSavePreferences_OverwritesExistingFile() throws {
            // Given
            let firstPreferences = UserPreferences(validationPresetID: "strict")
            let secondPreferences = UserPreferences(validationPresetID: "lenient")
