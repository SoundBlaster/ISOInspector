    ...
    @MainActor final class ResearchLogAccessibilityIdentifierTests: XCTestCase {
        ...
        func testDiagnosticsReceiveNestedIdentifiers() {
            ...
            let identifier = ResearchLogAccessibilityID.path(
                ResearchLogAccessibilityID.root, ResearchLogAccessibilityID.Diagnostics.root,
        ...
        func testMissingFixtureStatusAppliesNestedIdentifier() {
            ...
            let identifier = ResearchLogAccessibilityID.path(
                ResearchLogAccessibilityID.root, ResearchLogAccessibilityID.Header.root,
        ...
        private func hostPreview(snapshot: ResearchLogPreviewSnapshot) -> HostedPreview {
            let hostedView = ResearchLogAuditPreview(snapshot: snapshot).frame(
