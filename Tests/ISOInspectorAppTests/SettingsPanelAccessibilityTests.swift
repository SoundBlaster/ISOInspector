    ...
    @MainActor final class SettingsPanelAccessibilityTests: XCTestCase {
        ...
        func testAccessibilityIdentifiers_followNamingConvention() {
            ...
            XCTAssertTrue(
                SettingsPanelA11yID.permanentSettings.card.hasPrefix(SettingsPanelA11yID.root))
            XCTAssertTrue(
                SettingsPanelA11yID.sessionSettings.card.hasPrefix(SettingsPanelA11yID.root))
            XCTAssertTrue(
                SettingsPanelA11yID.advancedSettings.card.hasPrefix(SettingsPanelA11yID.root))
        }
